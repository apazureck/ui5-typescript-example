declare namespace sap.ui.core.Renderer {
     ...
     *         render: function(oRM, oany) {
     * 
     *             renderPreamble(oRM, oany);
     * 
     *             // implementation core renderer logic here
     * 
     *             renderPostamble(oRM, oany);
     * 
     *         },
     * 
     *         renderPreamble : function(oRM, oany) {
     *         ...
     *         },
     * 
     *         renderPostamble : function(oRM, oany) {
     *         ...
     *         }
     * 
     *     });
     ...
     * 
     *             // call base renderer
     *             LabelRenderer.renderPreamble(oRM, oany);
     * 
     *             // ... do your own fancy rendering here
     * 
     *             // call base renderer again
     *             LabelRenderer.renderPostamble(oRM, oany);
     *         }
     *     });
     * 
