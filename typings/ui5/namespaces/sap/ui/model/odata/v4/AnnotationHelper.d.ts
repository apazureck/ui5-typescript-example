declare namespace sap.ui.model.odata.v4.AnnotationHelper {
    ...
    */
    export function getany(vRawValue: any, oDetails: { context: any, schemaChildName: string, }): any;/**
 ...
 * Examples: `&lt;template:if test="{facet>Target/$AnnotationPath@@sap.ui.model.odata.v4.AnnotationHelper.isMultiple}">`
    */
    export function isMultiple(sPath: string, oDetails: { context: any, schemaChildName: string, }): boolean;/**
