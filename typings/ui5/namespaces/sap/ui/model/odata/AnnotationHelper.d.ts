declare namespace sap.ui.model.odata.AnnotationHelper {
     ...
     * }
     * 
     * oSupplierany = oMetaModel.getMetaany("/ProductSet('HT-1021')/ToSupplier");
     * oValueany = oMetaModel.createBindingany("com.sap.vocabularies.UI.v1.DataPoint/Value", oSupplierany);
     * 
     * vPropertySetting =  sap.ui.model.odata.AnnotationHelper.createPropertySetting([
     *     sap.ui.model.odata.AnnotationHelper.format(oValueany),
 ...
 * &lt;/template:if>`
    */
    export function getNavigationPath(oany: any | any, vRawValue?: any): string;/**
 ...
 *   &lt;template:with path="associationSetEnd>entitySet" helper="sap.ui.model.odata.AnnotationHelper.gotoEntitySet" var="entitySet"/>`
    */
    export function gotoEntitySet(oany: any): string;/**
    * Helper function for a `template:with` instruction that goes to the entity type with the qualified name which `oany` points at.
 * 
 * Example: Assume that "entitySet" refers to an entity set within an OData meta model; the helper function is then called on the "entityType" property of that entity set (which holds the qualified name of the entity type) and in turn the path of that entity type is assigned to the variable "entityType". `&lt;template:with path="entitySet>entityType" helper="sap.ui.model.odata.AnnotationHelper.gotoEntityType" var="entityType">`
    */
    export function gotoEntityType(oany: any): string;/**
    * Helper function for a `template:with` instruction that goes to the function import with the name which `oany` points at.
 * 
 * Example: Assume that "dataField" refers to a DataFieldForany within an OData meta model; the helper function is then called on the "any" property of that data field (which holds an object with the qualified name of the function import in the `String` property) and in turn the path of that function import is assigned to the variable "function". `&lt;template:with path="dataField>any"
 *   helper="sap.ui.model.odata.AnnotationHelper.gotoFunctionImport" var="function">`
    */
    export function gotoFunctionImport(oany: any): string;/**
 ...
 * Examples: `&lt;template:if test="{path: 'facet>Target', formatter: 'sap.ui.model.odata.AnnotationHelper.isMultiple'}">`
    */
    export function isMultiple(oany: any | any, vRawValue?: any): string;/**
 ...
 * Example: `&lt;template:with path="meta>Value" helper="sap.ui.model.odata.AnnotationHelper.resolvePath" var="target">`
    */
    export function resolvePath(oany: any): string;/**
 ...
 * Example: `&lt;sfi:SmartField value="{path: 'meta>Value', formatter: 'sap.ui.model.odata.AnnotationHelper.simplePath'}"/>`
    */
    export function simplePath(oany: any | any, vRawValue?: any): string;
}