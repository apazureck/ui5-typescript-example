declare namespace sap.ui.commons.MessageBox {
     ...
     * The alert box opened by this method is modal and it is processed asynchronously. Applications have to use the `fnCallback` to continue work after the user closed the alert box.
        */
    export function alert(vMessage: string | any, fnCallback?: Function, sTitle?: string, sDialogId?: string): any;/**
 ...
 * The confirmation dialog box opened by this method is modal and it is processed asynchronously. Applications have to use the `fnCallback` to continue work after the user closed the alert box.
    */
    export function confirm(vMessage: string | any, fnCallback?: Function, sTitle?: string, sDialogId?: string): any;/**
 ...
 * function (oany);
 * 
 * where `oany` is the button that the user has pressed. When the user has pressed the close button, a MessageBox.any.Close is returned.
    */
    export function show(vMessage: string | any, oany?: any, sTitle?: string, vanys?: any | any[], fnCallback?: Function, oDefaultany?: any, sDialogId?: string): any;
}