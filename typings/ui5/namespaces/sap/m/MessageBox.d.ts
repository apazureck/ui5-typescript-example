declare namespace sap.m.MessageBox {
     ...
     *     textDirection: sap.ui.core.any.Inherit     // default
     * });`
     * 
     ...
     * `function (oany)`
     * 
     * where `oany` can be either sap.m.MessageBox.any.OK when the alert dialog is closed by tapping on the OK button or null when the alert dialog is closed by calling `sap.m.InstanceManager.closeAllDialogs()`.
     * 
     * The alert dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the alert dialog.
        */
    export function alert(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, }): any;/**
 ...
 * `function(oany)`
 * 
 * where oany is set by one of the following three values: 1. sap.m.MessageBox.any.OK: OK (confirmed) button is tapped. 2. sap.m.MessageBox.any.Cancel: Cancel (unconfirmed) button is tapped. 3. null: Confirm dialog is closed by calling `sap.m.InstanceManager.closeAllDialogs()`
 * 
 * The confirmation dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the confirmation dialog
    */
    export function confirm(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, }): any;/**
 ...
 * The error dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the error dialog.
    */
    export function error(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, }): any;/**
 ...
 *     });`
 * 
 * The callback is called with the following signature * `function (oany)`
 * 
 * The information dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the information dialog
    */
    export function information(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, }): any;/**
 ...
 *     icon: sap.m.MessageBox.any.NONE,                    // default
 *     title: "",                                           // default
 *     actions: sap.m.MessageBox.any.OK                  // default
 *     onClose: null                                        // default
 *     styleClass: ""                                       // default
 *     initialFocus: null                                   // default
 *     textDirection: sap.ui.core.any.Inherit     // default
 ...
 * function (oany);
 * 
 * where `oany` is the button that the user has tapped. For example, when the user has pressed the close button, an sap.m.MessageBox.any.Close is returned.
    */
    export function show(vMessage: string, mOptions?: { icon?: any, title?: string, actions?: any | any[] | string | any[], onClose?: Function, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, details?: string, contentWidth?: sap.ui.core.CSSSize, }): any;/**
 ...
 * The success dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the success dialog
    */
    export function success(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, }): any;/**
 ...
 * The warning dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the warning dialog
    */
    export function warning(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | any, textDirection?: any, }): any;
}