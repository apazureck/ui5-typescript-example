declare namespace jQuery.sap.history {
    ...
    /**
        ...
        */
    export function addHistory(sIdf: string, oStateData: any, bBookmarkable: boolean, bVirtual?: boolean): string;/**
    * Adds a route to the history handling.
    */
    export function addRoute(sIdf: string, fn: Function, oThis?: any): any;/**
    ...
    */
    export function setDefaultHandler(fn: Function): any;
}