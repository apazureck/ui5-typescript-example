declare module "sap/m/MessageBox" {
     ...
     * The alert dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the alert dialog.
        */
    export function alert(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, }): any;/**
 ...
 * The confirmation dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the confirmation dialog
    */
    export function confirm(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, }): any;/**
 ...
 * The error dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the error dialog.
    */
    export function error(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, }): any;/**
 ...
 * The information dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the information dialog
    */
    export function information(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, }): any;/**
 ...
 * where `oAction` is the button that the user has tapped. For example, when the user has pressed the close button, an sap.m.MessageBox.Action.Close is returned.
    */
    export function show(vMessage: string, mOptions?: { icon?: Icon, title?: string, actions?: Action | any[] | string | any[], onClose?: Function, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, details?: string, contentWidth?: sap.ui.core.CSSSize, }): any;/**
 ...
 * The success dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the success dialog
    */
    export function success(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, }): any;/**
 ...
 * The warning dialog opened by this method is processed asynchronously. Applications have to use `fnCallback` to continue work after the user closed the warning dialog
    */
    export function warning(vMessage: string, mOptions?: { onClose?: Function, title?: string, id?: string, styleClass?: string, initialFocus?: string | Action, textDirection?: TextDirection, }): any;
}