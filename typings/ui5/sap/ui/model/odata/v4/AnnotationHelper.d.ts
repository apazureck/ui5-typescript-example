declare module "sap/ui/model/odata/v4/AnnotationHelper" {
    ...
    */
    export function getValueListType(vRawValue: any, oDetails: { context: Context, schemaChildName: string, }): ValueListType;/**
 ...
 * Examples: `&lt;template:if test="{facet>Target/$AnnotationPath@@sap.ui.model.odata.v4.AnnotationHelper.isMultiple}">`
    */
    export function isMultiple(sPath: string, oDetails: { context: Context, schemaChildName: string, }): boolean;/**
 ...
 * Example: `&lt;Label text="{meta>@@sap.ui.model.odata.v4.AnnotationHelper.label}" />`
    */
    export function label(vRawValue: any, oDetails: { context: Context, }): string;/**
 ...
 * Example: `&lt;Text text="{meta>Value/@@sap.ui.model.odata.v4.AnnotationHelper.value}" />`
    */
    export function value(vRawValue: any, oDetails: { context: Context, }): string;
}