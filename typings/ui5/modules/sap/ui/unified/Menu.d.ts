declare module "sap/ui/unified/Menu" {
    ...
    */
    class Menu extends sap.ui.core.Control {
        ...
        */
        attachItemSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The action (item) which was selected by the user. */
            item: MenuItemBase,
         ...
         * Fired on the root menu of a menu hierarchy whenever a user selects an item within the menu or within one of its direct or indirect submenus. ** Note: ** There is also a select event available for each single menu item. This event and the event of the menu items are redundant.
        */
        attachItemSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The action (item) which was selected by the user. */
            item: MenuItemBase,
        ...
        */
        public open(bWithKeyboard: boolean, oOpenerRef: sap.ui.core.Element | any, my: sap.ui.core.Dock, at: sap.ui.core.Dock, of: sap.ui.core.Element | any, offset?: string, collision?: sap.ui.core.Collision): any;
