    ...
    */
    export default class TimesRow extends sap.ui.core.Control {
        ...
        */
         ...
         * Time focus changed
        */
        attachFocus<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * date, as JavaScript Date object, of the focused time. */
         ...
         * Time focus changed
        */
        attachFocus<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * date, as JavaScript Date object, of the focused time. */
            date: any, /* * If set, the focused date is not rendered yet. (This happens by navigating out of the visible area.) */
            notVisible: boolean,
