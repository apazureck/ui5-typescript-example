    ...
    */
    export default class MonthsRow extends sap.ui.core.Control {
        ...
        */
         ...
         * Month focus changed
        */
        attachFocus<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * First date, as JavaScript Date object, of the month that is focused. */
            date: any, /* * If set, the focused date is not rendered yet. (This happens by navigating out of the visible area.) */
            notVisible: boolean,
         ...
         * Month focus changed
        */
        attachFocus<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * First date, as JavaScript Date object, of the month that is focused. */
            date: any, /* * If set, the focused date is not rendered yet. (This happens by navigating out of the visible area.) */
            notVisible: boolean,
        ...
        */
        protected fireFocus(mParameters?: { date?: any, notVisible?: boolean, }): this;
