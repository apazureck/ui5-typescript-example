    ...
    */
    export default class Month extends sap.ui.core.Control {
        ...
        */
         ...
         * Date focus changed
        */
        attachFocus<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * focused date */
         ...
         * Date focus changed
        */
        attachFocus<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * focused date */
            date: any, /* * focused date is in an other month that the displayed one */
            otherMonth: boolean, /* * focused date is set to the same as before (date in other month clicked) */
            restoreOldDate: boolean,
