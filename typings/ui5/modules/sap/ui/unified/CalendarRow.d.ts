declare module "sap/ui/unified/CalendarRow" {
    ...
    */
    class CalendarRow extends sap.ui.core.Control {
        ...
        */
        attachIntervalSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Interval start date as JavaScript date object */
            startDate: any, /* * Interval end date as JavaScript date object */
         ...
         * Fired if an interval was selected
        */
        attachIntervalSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Interval start date as JavaScript date object */
            startDate: any, /* * Interval end date as JavaScript date object */
            endDate: any, /* * If set, the selected interval is a subinterval */
            subInterval: boolean,
        ...
        */
        attachLeaveRow<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The type of the event that triggers this <code>leaveRow</code> */
            type: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * The `CalendarRow` should be left while navigating. (Arrow up or arrow down.) The caller should determine the next control to be focused
        */
        attachLeaveRow<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The type of the event that triggers this <code>leaveRow</code> */
            type: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * selected appointment */
            appointment: CalendarAppointment, /* * selected appointments in case a group appointment is selected */
            appointments: any[], /* * If set, the appointment was selected by multiple selection (e.g. shift + mouse click). So more than the current appointment could be selected. */
         ...
         * Fired if an appointment was selected
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * selected appointment */
            appointment: CalendarAppointment, /* * selected appointments in case a group appointment is selected */
            appointments: any[], /* * If set, the appointment was selected by multiple selection (e.g. shift + mouse click). So more than the current appointment could be selected. */
            multiSelect: boolean, /* * Gives the ID of the DOM element of the clicked appointment */
            domRefId: string,
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachLeaveRow(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireIntervalSelect(mParameters?: { startDate?: any, endDate?: any, subInterval?: boolean, }): this;
        ...
        */
        protected fireSelect(mParameters?: { appointment?: CalendarAppointment, appointments?: any[], multiSelect?: boolean, domRefId?: string, }): this;
        ...
        */
        public focusNearestAppointment(oDate: any): this;
        ...
        */
        public getIntervalType(): CalendarIntervalType;
        ...
        */
        public removeAllAppointments(): any[];
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllIntervalHeaders(): any[];
        ...
        */
         ...
         * Default value is `Hour`.
        */
        public setIntervalType(sIntervalType: CalendarIntervalType): this;
        ...
        */
         ...
         * When called with a value of `null` or `undefined`, the default value of the property will be restored.
        */
        public setNonWorkingDays(sNonWorkingDays: any[]): this;
         ...
         * When called with a value of `null` or `undefined`, the default value of the property will be restored.
        */
        public setNonWorkingHours(sNonWorkingHours: any[]): this;
