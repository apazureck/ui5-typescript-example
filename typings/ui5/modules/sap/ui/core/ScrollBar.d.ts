    ...
    */
    class ScrollBar extends sap.ui.core.Control {
        ...
        */
         ...
         * Scroll event.
        */
        attachScroll<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Actions are: Click on track, button, drag of thumb, or mouse wheel click. */
         ...
         * Scroll event.
        */
        attachScroll<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Actions are: Click on track, button, drag of thumb, or mouse wheel click. */
            action: sap.ui.core.ScrollBarAction, /* * Direction of scrolling: back (up) or forward (down). */
            forward: boolean, /* * Current Scroll position either in pixels or in steps. */
            newScrollPos: number, /* * Old Scroll position - can be in pixels or in steps. */
            oldScrollPos: number,
