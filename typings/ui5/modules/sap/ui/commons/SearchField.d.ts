declare module "sap/ui/commons/SearchField" {
    ...
    */
    class SearchField extends sap.ui.core.Control {
        ...
        */
        attachSuggest<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The value for which suggestions are required. */
            value: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Event which is fired when new suggest values are required.
        */
        attachSuggest<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The value for which suggestions are required. */
            value: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
