declare module "sap/ui/commons/TabStrip" {
    ...
    */
    class TabStrip extends sap.ui.core.Control {
        ...
        */
        attachClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The index of the closed tab. */
            index: number,
         ...
         * Fires when the user closes a tab.
        */
        attachClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The index of the closed tab. */
            index: number,
        ...
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The index of the selected tab. */
            index: number,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fires when the user selects a tab.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The index of the selected tab. */
            index: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public createTab(sText: string, oContent: sap.ui.core.Control): Tab;
