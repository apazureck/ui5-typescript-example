declare module "sap/ui/commons/Slider" {
    ...
    */
    class Slider extends sap.ui.core.Control {
        ...
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current value of the slider after a change. */
            value: number,
         ...
         * Value was changed. This event is fired if the value has changed by a user action.
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current value of the slider after a change. */
            value: number,
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current value of the slider after a change. */
            value: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Value was changed. This event is fired during the mouse move. The normal change event is only fired by mouseup.
        */
        attachLiveChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current value of the slider after a change. */
            value: number,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * When called with a value of `null` or `undefined`, the default value of the property will be restored.
        */
        public setLabels(sLabels: any[]): this;
