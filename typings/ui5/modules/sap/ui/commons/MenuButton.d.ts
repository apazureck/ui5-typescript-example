declare module "sap/ui/commons/MenuButton" {
    ...
    */
    class MenuButton extends Button {
        ...
        */
        attachItemSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the selected item */
         ...
         * Event that is fired when a menu item is selected by the user
        */
        attachItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the selected item */
            itemId: string, /* * The selected item */
            item: MenuItemBase,
        ...
        */
        attachPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The id of the selected item */
            itemId: string, /* * The selected item */
         ...
         * Event is fired when an item from the menu was selected.
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The id of the selected item */
            itemId: string, /* * The selected item */
            item: sap_ui_commons_MenuItemBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
