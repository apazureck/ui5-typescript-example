declare module "sap/ui/commons/RoadMap" {
    ...
    */
    class RoadMap extends sap.ui.core.Control {
        ...
        */
        attachStepExpanded<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * ID of the expanded/collapsed step */
            stepId: string,
         ...
         * Event is fired when a given step is expanded or collapsed by user.
        */
        attachStepExpanded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * ID of the expanded/collapsed step */
            stepId: string,
        ...
        */
        attachStepSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * ID of the selected step */
            stepId: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the user selects a step.
        */
        attachStepSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * ID of the selected step */
            stepId: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachStepExpanded(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachStepSelected(fnFunction: Function, oListener: any): this;
