declare module "sap/ui/commons/RowRepeater" {
    ...
    */
    export default class RowRepeater extends sap.ui.core.Control {
        ...
        */
        public addRow(oRow: sap.ui.core.Control): this;
        ...
        */
        attachFilter<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the filter that has just been applied. */
            filterId: string,
         ...
         * This event is triggered when a filter is set.
        */
        attachFilter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the filter that has just been applied. */
            filterId: string,
        ...
        */
        attachPage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The value of the currentPage property after the change. */
         ...
         * This event is triggered when paging was executed.
        */
        attachPage<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The value of the currentPage property after the change. */
            currentPage: number, /* * The value of the currentPage property before the change. */
            previousPage: number,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachResize<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The value of the numberOfRows property after the change. */
         ...
         * This event is triggered when the number of rows was changed.
        */
        attachResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The value of the numberOfRows property after the change. */
            numberOfRows: number, /* * The value of the numberOfRows property before the change. */
            previousNumberOfRows: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSort<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the sorter that has just been applied. */
            sorterId: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * This event is triggered when a sorting is applied.
        */
        attachSort<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the sorter that has just been applied. */
            sorterId: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public getDesign(): RowRepeaterDesign;
        ...
        */
        public insertRow(oRow: sap.ui.core.Control, iIndex: number): this;
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public setDesign(sDesign: RowRepeaterDesign): this;
        ...
        */
        public setNoData(oNoData: sap.ui.core.Control): this;
