declare module "sap/ui/commons/AutoComplete" {
    ...
    */
    class AutoComplete extends ComboBox {
        ...
        */
        attachSuggest<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value which was typed in. */
            suggestValue: string,
         ...
         * Fired when the user has changed the value and a suggestion list update should occur.
        */
        attachSuggest<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value which was typed in. */
            suggestValue: string,
        ...
        */
        public setFilterFunction(fFilter?: Function): any;
