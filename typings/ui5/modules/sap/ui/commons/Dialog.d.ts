declare module "sap/ui/commons/Dialog" {
    ...
    */
    export default class Dialog extends sap.ui.core.Control {
        ...
        */
        attachClosed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The width of the dialog when closed */
         ...
         * Event is fired when the dialog has been closed (after closing-animation etc.). Event parameters provide information about last position and last size.
        */
        attachClosed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The width of the dialog when closed */
            width: number, /* * The height of the dialog when closed */
            height: number, /* * The top position of the dialog when closed */
            top: number, /* * The left position of the dialog when closed */
            left: number,
        ...
        */
        public getContentBorderDesign(): BorderDesign;
        ...
        */
         ...
         * Default value is `None`.
        */
        public setContentBorderDesign(sContentBorderDesign: BorderDesign): this;
