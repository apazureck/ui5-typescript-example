declare module "sap/ui/commons/DropdownBox" {
    ...
    */
    export default class DropdownBox extends ComboBox {
        ...
        */
        attachSearchHelp<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the DropdownBox. */
            value: string,
         ...
         * Event fired whenever the configured searchHelpItem is clicked or the searchHelpItem is configured and F4 key is pressed.
        */
        attachSearchHelp<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the DropdownBox. */
            value: string,
        ...
        */
        public detachSearchHelp(fnFunction: Function, oListener: any): this;
