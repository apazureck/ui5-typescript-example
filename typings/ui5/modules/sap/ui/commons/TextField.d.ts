declare module "sap/ui/commons/TextField" {
    ...
    */
    export default class TextField extends sap.ui.core.Control {
        ...
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new / changed value of the <code>TextField</code>. */
            newValue: string,
         ...
         * Event is fired when the text in the field has changed AND the focus leaves the TextField or the Enter key is pressed.
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new / changed value of the <code>TextField</code>. */
            newValue: string,
        ...
        */
        attachLiveChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current visible value of the <code>TextField</code>. */
            liveValue: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * This event if fired during typing into the `TextField` and returns the currently entered value. ** Note: ** This is not the content of the value property. The value property is only updated by ENTER and by leaving the control.
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current visible value of the <code>TextField</code>. */
            liveValue: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
