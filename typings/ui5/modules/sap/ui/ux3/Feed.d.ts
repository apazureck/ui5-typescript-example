declare module "sap/ui/ux3/Feed" {
    ...
    */
    class Feed extends sap.ui.core.Control {
        ...
        */
        attachChunkAdded<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * New chunk */
            chunk: FeedChunk,
         ...
         * Event is fired when a new chunk is added
        */
        attachChunkAdded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * New chunk */
            chunk: FeedChunk,
        ...
        */
        attachFilterChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new/changed value of the filter */
            newValue: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the filter is changed
        */
        attachFilterChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new/changed value of the filter */
            newValue: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachToggleLive<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current live indicator */
            live: boolean,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the live mode has changed
        */
        attachToggleLive<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current live indicator */
            live: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachToolsItemSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The Id of the selected item */
         ...
         * Event is fired when an item from the tools MenuButton was selected
        */
        attachToolsItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The Id of the selected item */
            itemId: string, /* * The selected item */
            item: MenuItemBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public bindChunks(oBindingInfo: any): this;
        ...
        */
         ...
         * See {@link sap.ui.base.ManagedObject#bindAggregation ManagedObject.bindAggregation} for a detailed description of the possible properties of `oBindingInfo`.
        */
        public bindToolsMenuItems(oBindingInfo: any): this;
        ...
        */
        public detachChunkAdded(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFilterChange(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachToggleLive(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachToolsItemSelected(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllToolsMenuItems(): any[];
