declare module "sap/ui/ux3/FeedChunk" {
    ...
    */
    class FeedChunk extends sap.ui.core.Control {
        ...
        */
        attachActionItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The Id of the selected item */
         ...
         * Event is fired when an item from the action menu button was selected.
        */
        attachActionItemSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The Id of the selected item */
            itemId: string, /* * The selected item */
            item: MenuItemBase,
        ...
        */
        attachCommentAdded<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * New comment chunk */
            comment: FeedChunk,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Event is raised when a comment is added to the entry. This event is not supported for comment chunks.
        */
        attachCommentAdded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * New comment chunk */
            comment: FeedChunk,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachDeleted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the deletion button is pressed.
        */
        attachDeleted<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachInspect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the inspect button was pressed
        */
        attachInspect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachReferenceClicked<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Text of the @-reference */
            text: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Click on a @-reference
        */
        attachReferenceClicked<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Text of the @-reference */
            text: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSenderClicked<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the thumbnail or the name of the sender is clicked.
        */
        attachSenderClicked<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachToggleFavorite<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current favorite state */
            favorite: boolean,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Event is raised when the user clicks to set the entry as favorite. This event is not supported for comment chunks.
        */
        attachToggleFavorite<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current favorite state */
            favorite: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachToggleFlagged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current flagged state */
            flagged: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Event is raised when the user clicks to flag the entry. This event is not supported for comment chunks.
        */
        attachToggleFlagged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current flagged state */
            flagged: boolean,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachToggleShared<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current shared state */
            shareed: boolean,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Event is raised when the user clicks to share the entry. This event is not supported for comment chunks.
        */
        attachToggleShared<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Current shared state */
            shareed: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public bindActionMenuItems(oBindingInfo: any): this;
         ...
         * See {@link sap.ui.base.ManagedObject#bindAggregation ManagedObject.bindAggregation} for a detailed description of the possible properties of `oBindingInfo`.
        */
        public bindComments(oBindingInfo: any): this;
        ...
        */
        public detachActionItemSelected(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachCommentAdded(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachDeleted(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachInspect(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachReferenceClicked(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachSenderClicked(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachToggleFavorite(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachToggleFlagged(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachToggleShared(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireDeleted(mParameters?: any): this;

        /**
            * Fires event {@link #event:inspect inspect} to attached listeners.
        */
        protected fireInspect(mParameters?: any): this;
        ...
        */
        protected fireSenderClicked(mParameters?: any): this;
        ...
        */
        public removeAllActionMenuItems(): any[];
