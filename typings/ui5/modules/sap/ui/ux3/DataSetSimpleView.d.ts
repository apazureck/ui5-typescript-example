declare module "sap/ui/ux3/DataSetSimpleView" {
    ...
    */
    class DataSetSimpleView extends sap.ui.core.Control {
        ...
        */
        protected exitView(aItems: any[]): any;
        ...
        */
        protected handleSelection(oEvent: sap.ui.base.Event<this, void>): any;
        ...
        */
        public setScrollArea(aScrollArea: any[], bSupress: boolean): any;

        /**
            * Sets the aggregated {@link #getTemplate template}.
        */
        public setTemplate(oTemplate: sap.ui.core.Control): this;
