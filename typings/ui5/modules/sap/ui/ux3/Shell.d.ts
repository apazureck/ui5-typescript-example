declare module "sap/ui/ux3/Shell" {
    ...
    */
    class Shell extends sap.ui.core.Control {
        ...
        */
        public addHeaderItem(oHeaderItem: sap.ui.core.Control): this;
        ...
        */
        attachFeedSubmit<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Fired when a new feed entry is submitted.
        */
        attachFeedSubmit<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachLogout<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Fired when the user clicks the "Log-off" button
        */
        attachLogout<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachPaneBarItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the selected PaneBarItem. */
         ...
         * An item in the right-hand-side pane bar has been selected, the pane is now visible and can be filled with UI elements.
        */
        attachPaneBarItemSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the selected PaneBarItem. */
            id: string, /* * The selected Item */
            item: Item, /* * The key of the selected Item (or null if there is no key) */
            key: string,
        ...
        */
        attachPaneClosed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The id of the PaneBarItem to which the closed pane belonged. */
            id: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fired after a side pane of the shell is closed. It is also fired, when an open pane is closed by calling setShowPane(false), if and only if the pane was opened before.
        */
        attachPaneClosed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The id of the PaneBarItem to which the closed pane belonged. */
            id: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSearch<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fired when search has been triggered.
        */
        attachSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachWorksetItemSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The id of the workset item that has been newly selected by the user. If a top-level item has been clicked which has sub-items, the ID of the currently active sub-item (/leaf) is given. */
         ...
         * Fired when a workset item was selected by the user. The application may populate the sub-items of the given workset item in the event handler, but this must happen synchronously. If this is done, the application is responsible for displaying the correct content for the selected one of the newly created sub-items. The Shell will currently always mark the first sub-item as selected.
        */
        attachWorksetItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The id of the workset item that has been newly selected by the user. If a top-level item has been clicked which has sub-items, the ID of the currently active sub-item (/leaf) is given. */
            id: string, /* * The selected NavigationItem */
            item: NavigationItem, /* * The key of the selected NavigationItem (or null if there is no key) */
            key: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachLogout(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachPaneBarItemSelected(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachPaneClosed(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachWorksetItemSelected(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireFeedSubmit(mParameters?: any): this;

        /**
            * Fires event {@link #event:logout logout} to attached listeners.
        */
        protected fireLogout(mParameters?: any): this;
        ...
        */
        public getDesignType(): ShellDesignType;
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public getHeaderType(): ShellHeaderType;
        ...
        */
        public initializePersonalization(oSettings: any): any;
        ...
        */
        public insertHeaderItem(oHeaderItem: sap.ui.core.Control, iIndex: number): this;
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllHeaderItems(): any[];
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllPaneBarItems(): any[];
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllToolPopups(): any[];
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllWorksetItems(): any[];
        ...
        */
        public setContent(oContent: sap.ui.core.Control, bDestroyOldContent: boolean): any[];
         ...
         * Default value is `Standard`.
        */
        public setDesignType(sDesignType: ShellDesignType): this;
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public setHeaderType(sHeaderType: ShellHeaderType): this;
        ...
        */
        protected setOffsetRight(px: number, complete?: Function, outerId?: string): any;
        ...
        */
        public setPaneContent(oContent: sap.ui.core.Control, bDestroyOldContent: boolean): any[];
