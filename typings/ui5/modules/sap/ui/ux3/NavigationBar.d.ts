declare module "sap/ui/ux3/NavigationBar" {
    ...
    */
    export default class NavigationBar extends sap.ui.core.Control {
        ...
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the newly selected NavigationItem. */
         ...
         * Event is fired when an item is selected by the user
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the newly selected NavigationItem. */
            itemId: string, /* * The newly selected NavigationItem. */
            item: NavigationItem,
        ...
        */
        public removeAllAssociatedItems(): any[];
        ...
        */
        public setAssociatedItems(aItems: any[]): this;
