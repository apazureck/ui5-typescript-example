declare module "sap/ui/ux3/ExactAttribute" {
    ...
    */
    export default class ExactAttribute extends sap.ui.core.Element {
        ...
        */
        attachSupplyAttributes<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ExactAttribute */
         ...
         * A supply function is a handler which is attached to the supplyAttributes event. The event is fired when the corresponding ExactAttribute is selected, it was already selected when a handler is attached or function getAttributes() is called.
        */
        attachSupplyAttributes<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ExactAttribute */
            attribute: ExactAttribute,
        ...
        */
        protected setProperty(sPropertyName: string, oValue: any, bSuppressRerendering: boolean): any | sap.ui.base.ManagedObject;
        ...
        */
        public setTooltip(oTooltip: string | sap.ui.core.TooltipBase): any;
