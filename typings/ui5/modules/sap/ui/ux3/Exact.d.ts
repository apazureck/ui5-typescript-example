declare module "sap/ui/ux3/Exact" {
    ...
    */
    export default class Exact extends sap.ui.core.Control {
        ...
        */
        attachRefineSearch<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The query string which was entered in the search field */
         ...
         * Event which is fired when an attribute is selected or unselected.
        */
        attachRefineSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The query string which was entered in the search field */
            query: string, /* * The attribute which was selected or unselected recently */
            changedAttribute: ExactAttribute, /* * Array of all selected ExcatAttribute. */
            allSelectedAttributes: any,
        ...
        */
        attachSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The query string which was entered in the search field. */
            query: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when the search button is clicked
        */
        attachSearch<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The query string which was entered in the search field. */
            query: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachRefineSearch(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireRefineSearch(mParameters?: { query?: string, changedAttribute?: ExactAttribute, allSelectedAttributes?: any, }): this;
