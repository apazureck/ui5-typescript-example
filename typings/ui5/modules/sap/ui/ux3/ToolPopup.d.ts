declare module "sap/ui/ux3/ToolPopup" {
    ...
    */
    export default class ToolPopup extends sap.ui.core.Control {
        ...
        */
        public addButton(oButton: sap.ui.core.Control): this;
        ...
        */
        attachEnter<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The onsapenter event, received by the pop up */
            originalEvent: any, /* * The control that was focused when the user pressed the Enter key (may be null) */
         ...
         * Event is fired whenever the user clicks the Enter or the Enter key inside the pop up
        */
        attachEnter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The onsapenter event, received by the pop up */
            originalEvent: any, /* * The control that was focused when the user pressed the Enter key (may be null) */
            originalSrcControl: sap.ui.core.Control,
        ...
        */
        attachIconChanged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when one of the icon properties is modified (Note: The icon is not rendered by the ToolPopup). To be used by other controls which want to update the icon in their UI.
        */
        attachIconChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachEnter(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachIconChanged(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireEnter(mParameters?: { originalEvent?: any, originalSrcControl?: sap.ui.core.Control, }): this;

        /**
            * Fires event {@link #event:iconChanged iconChanged} to attached listeners.
        */
        protected fireIconChanged(mParameters?: any): this;
        ...
        */
        public insertButton(oButton: sap.ui.core.Control, iIndex: number): this;
        ...
        */
        public open(my?: Dock, at?: Dock): this;
        ...
        */
        public setAutoCloseAreas(aAutoCloseAreas: any[]): any;
        ...
        */
        public setDefaultButton(oDefaultButton: sap.ui.core.ID | sap.ui.core.Control): this;
        ...
        */
        public setOpener(oOpener: sap.ui.core.ID | sap.ui.core.Control): this;
