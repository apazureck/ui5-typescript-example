declare module "sap/ui/ux3/QuickView" {
    ...
    */
    export default class QuickView extends CalloutBase {
        ...
        */
        public addContent(oContent: sap.ui.core.Element): this;
        ...
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * URI of the Thing Inspector application. */
            href: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Event is fired when a user clicks on the firstTitle link. Call the preventDefault method of the event object to cancel browser navigation.
        */
        attachNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * URI of the Thing Inspector application. */
            href: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public insertContent(oContent: sap.ui.core.Element, iIndex: number): this;
