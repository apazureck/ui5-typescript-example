declare module "sap/ui/table/Column" {
    ...
    */
    export default class Column extends sap.ui.core.Element {
        ...
        */
        public addMultiLabel(oMultiLabel: sap.ui.core.Control): this;
        ...
        */
        attachColumnMenuOpen<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Refence to the selected <code>menu</code> instance to be opened. */
            menu: Menu,
         ...
         * Fires before the column menu is opened.
        */
        attachColumnMenuOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Refence to the selected <code>menu</code> instance to be opened. */
            menu: Menu,
        ...
        */
        public detachColumnMenuOpen(fnFunction: Function, oListener: any): this;
        ...
        */
        public getTemplate(): sap.ui.core.Control | string;

        /**
            * Returns a column template clone. It either finds an unused clone or clones a new one from the column template.
        */
        protected getTemplateClone(iIndex: number): sap.ui.core.Control | any;
        ...
        */
        public insertMultiLabel(oMultiLabel: sap.ui.core.Control, iIndex: number): this;
        ...
        */
        public removeAllMultiLabels(): any[];
        ...
        */
        public setLabel(vLabel: sap.ui.core.Control | string): this;
        ...
        */
         ...
         * Default value is `Ascending`.
        */
        public setSortOrder(sSortOrder: SortOrder): this;
        ...
        */
        public setTemplate(vTemplate: sap.ui.core.Control | string): this;
