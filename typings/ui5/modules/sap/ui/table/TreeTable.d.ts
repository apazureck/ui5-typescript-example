declare module "sap/ui/table/TreeTable" {
    ...
    */
    class TreeTable extends Table {
        ...
        */
        attachToggleOpenState<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Index of the expanded/collapsed row */
            rowIndex: number, /* * Binding context of the expanded/collapsed row */
            rowContext: any, /* * Flag that indicates whether the row has been expanded or collapsed */
            expanded: boolean,
         ...
         * Fired when a row has been expanded or collapsed by user interaction. Only available in hierarchical mode.
        */
        attachToggleOpenState<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Index of the expanded/collapsed row */
            rowIndex: number, /* * Binding context of the expanded/collapsed row */
            rowContext: any, /* * Flag that indicates whether the row has been expanded or collapsed */
            expanded: boolean,
        ...
        */
        protected fireToggleOpenState(mParameters?: { rowIndex?: number, rowContext?: any, expanded?: boolean, }): this;
        ...
        */
        public getSelectedIndices(): any[] | any;
