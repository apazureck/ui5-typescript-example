declare module "sap/ui/table/Table" {
    ...
    */
    class Table extends sap.ui.core.Control {
        ...
        */
        public addExtension(oExtension: sap.ui.core.Control): this;
        ...
        */
        attachBusyStateChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * This event gets fired when the busy state of the table changes. It should only be used by composite controls.
        */
        attachBusyStateChanged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachCellClick<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The control of the cell. */
            cellControl: sap.ui.core.Control, /* * DOM reference of the clicked cell. Can be used to position the context menu. */
            cellDomRef: any, /* * Row index of the selected cell. */
         ...
         * fired when the user clicks a cell of the table (experimental!).
        */
        attachCellClick<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The control of the cell. */
            cellControl: sap.ui.core.Control, /* * DOM reference of the clicked cell. Can be used to position the context menu. */
            cellDomRef: any, /* * Row index of the selected cell. */
            rowIndex: number, /* * Column index of the selected cell. This is the index of visible columns and might differ from the index maintained in the column aggregation. */
            columnIndex: number, /* * Column ID of the selected cell. */
        ...
        */
        attachCellContextmenu<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The control of the cell. */
            cellControl: sap.ui.core.Control, /* * DOM reference of the clicked cell. Can be used to position the context menu. */
            cellDomRef: any, /* * Row index of the selected cell. */
            rowIndex: number, /* * Column index of the selected cell. This is the index of visible columns and might differ from the index maintained in the column aggregation. */
            columnIndex: number, /* * Column ID of the selected cell. */
         ...
         * fired when the user clicks a cell of the table.
        */
        attachCellContextmenu<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The control of the cell. */
            cellControl: sap.ui.core.Control, /* * DOM reference of the clicked cell. Can be used to position the context menu. */
            cellDomRef: any, /* * Row index of the selected cell. */
            rowIndex: number, /* * Column index of the selected cell. This is the index of visible columns and might differ from the index maintained in the column aggregation. */
            columnIndex: number, /* * Column ID of the selected cell. */
        ...
        */
        attachColumnFreeze<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * reference to the column to freeze */
            column: Column,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * fired when a column of the table should be freezed
        */
        attachColumnFreeze<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * reference to the column to freeze */
            column: Column,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachColumnMove<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * moved column. */
         ...
         * fired when a table column is moved.
        */
        attachColumnMove<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * moved column. */
            column: Column, /* * new position of the column. */
            newPos: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachColumnResize<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * resized column. */
         ...
         * fired when a table column is resized.
        */
        attachColumnResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * resized column. */
            column: Column, /* * new width of the table column as CSS Size definition. */
            width: sap.ui.core.CSSSize,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachColumnSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * reference to the selected column */
            column: Column,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * fired when a column of the table has been selected
        */
        attachColumnSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * reference to the selected column */
            column: Column,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachColumnVisibility<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * affected column. */
         ...
         * fired when the visibility of a table column is changed.
        */
        attachColumnVisibility<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * affected column. */
            column: Column, /* * new value of the visible property. */
            visible: boolean,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachCustomFilter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * This event is triggered when the custom filter item of the column menu is pressed. The column on which the event was triggered is passed as parameter.
        */
        attachCustomFilter<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachFilter<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * filtered column. */
         ...
         * fired when the table is filtered.
        */
        attachFilter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * filtered column. */
            column: Column, /* * filter value. */
            value: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachFirstVisibleRowChanged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * This event gets fired when the first visible row is changed. It should only be used by composite controls. The event even is fired when setFirstVisibleRow is called programmatically.
        */
        attachFirstVisibleRowChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachGroup<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * grouped column. */
            column: Column,
        }>) => void, oListener?: Tcontext): this;
         ...
         * fired when the table is grouped (experimental!).
        */
        attachGroup<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * grouped column. */
            column: Column,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachRowSelectionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * row index which has been clicked so that the selection has been changed (either selected or deselected) */
            rowIndex: number, /* * binding context of the row which has been clicked so that selection has been changed */
            rowContext: any, /* * array of row indices which selection has been changed (either selected or deselected) */
            rowIndices: any[], /* * indicator if "select all" function is used to select rows */
         ...
         * fired when the row selection of the table has been changed (the event parameters can be used to determine selection changes - to find out the selected rows you should better use the table selection API)
        */
        attachRowSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * row index which has been clicked so that the selection has been changed (either selected or deselected) */
            rowIndex: number, /* * binding context of the row which has been clicked so that selection has been changed */
            rowContext: any, /* * array of row indices which selection has been changed (either selected or deselected) */
            rowIndices: any[], /* * indicator if "select all" function is used to select rows */
            selectAll: boolean, /* * indicates that the event was fired due to an explicit user interaction like clicking the row header or using the keyboard (SPACE or ENTER) to select a row or a range of rows. */
        ...
        */
        attachSort<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * sorted column. */
            column: Column, /* * Sort Order */
            sortOrder: SortOrder, /* * If column was added to sorter this is true. If new sort is started this is set to false */
            columnAdded: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * fired when the table is sorted.
        */
        attachSort<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * sorted column. */
            column: Column, /* * Sort Order */
            sortOrder: SortOrder, /* * If column was added to sorter this is true. If new sort is started this is set to false */
            columnAdded: boolean,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * See {@link sap.ui.base.ManagedObject#bindAggregation ManagedObject.bindAggregation} for a detailed description of the possible properties of `oBindingInfo`.
        */
        public bindRows(oBindingInfo: any): this;
        ...
        */
        public detachBusyStateChanged(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachCellClick(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachCellContextmenu(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachColumnFreeze(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachColumnMove(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachColumnResize(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachColumnSelect(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachColumnVisibility(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachCustomFilter(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFilter(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFirstVisibleRowChanged(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachGroup(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachRowSelectionChange(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachSort(fnFunction: Function, oListener: any): this;
        ...
        */
        public exportData(mSettings?: any): any;
        ...
        */
        protected fireCellClick(mParameters?: { cellControl?: sap.ui.core.Control, cellDomRef?: any, rowIndex?: number, columnIndex?: number, columnId?: string, rowBindingContext?: sap.ui.model.Context, }): boolean;
         ...
         * Listeners may prevent the default action of this event by using the `preventDefault`-method on the event object.
        */
        protected fireCellContextmenu(mParameters?: { cellControl?: sap.ui.core.Control, cellDomRef?: any, rowIndex?: number, columnIndex?: number, columnId?: string, rowBindingContext?: sap.ui.model.Context, }): boolean;
        ...
        */
        protected fireRowSelectionChange(mParameters?: { rowIndex?: number, rowContext?: any, rowIndices?: any[], selectAll?: boolean, userInteraction?: boolean, }): this;
         ...
         * Listeners may prevent the default action of this event by using the `preventDefault`-method on the event object.
        */
        protected fireSort(mParameters?: { column?: Column, sortOrder?: SortOrder, columnAdded?: boolean, }): boolean;
        ...
        */
        public getVisibleRowCountMode(): VisibleRowCountMode;
        ...
        */
        public insertExtension(oExtension: sap.ui.core.Control, iIndex: number): this;
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllDragDropConfig(): any[];
        ...
        */
        public setFooter(vFooter: sap.ui.core.Control | string): this;
        ...
        */
         ...
         * Default value is `Scrollbar`.
        */
        public setNavigationMode(sNavigationMode: NavigationMode): this;

        /**
            * Sets the aggregated {@link #getNoData noData}.
        */
        public setNoData(vNoData: sap.ui.core.Control | string): this;
        ...
        */
         ...
         * Default value is `RowSelector`.
        */
        public setSelectionBehavior(sSelectionBehavior: SelectionBehavior): this;
        ...
        */
        public setTitle(vTitle: sap.ui.core.Control | string): this;
        ...
        */
         ...
         * Default value is `Fixed`.
        */
        public setVisibleRowCountMode(sVisibleRowCountMode: VisibleRowCountMode): this;
        ...
        */
        public sort(oColumn: Column | any, oSortOrder: SortOrder, bAdd: boolean): this;
