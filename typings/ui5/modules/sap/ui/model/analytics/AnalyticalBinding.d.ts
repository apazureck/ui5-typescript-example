declare module "sap/ui/model/analytics/AnalyticalBinding" {
    ...
    */
    class AnalyticalBinding extends sap.ui.model.TreeBinding {
        ...
        */
        public constructor(oModel: sap.ui.model.Model, sPath: string, oContext?: any, aSorter?: any[], aFilters?: any[], mParameters?: { entitySet?: any, useBatchRequests?: any, provideGrandTotals?: any, provideTotalResultSize?: any, reloadSingleUnitMeasures?: any, select?: string, });
        ...
        */
        public filter(aFilter: any[] | sap.ui.model.Filter, sFilterType?: sap.ui.model.FilterType): this;

        /**
            * Gets the analytical information for a column with a given name.
        */
        public getAnalyticalInfoForColumn(sColumnName: string): any;
        ...
        */
        public hasChildren(oContext: sap.ui.model.Context, mParameters?: any): boolean;
        ...
        */
        public sort(aSorter: sap.ui.model.Sorter | any[]): this;
