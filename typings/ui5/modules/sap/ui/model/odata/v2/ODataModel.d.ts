declare module "sap/ui/model/odata/v2/ODataModel" {
    ...
    */
    class ODataModel extends sap.ui.model.Model {
        ...
        */
        public constructor(serviceUrl: string | any, mParameters?: { serviceUrl?: any, json?: boolean, user?: string, password?: string, headers?: any, tokenHandling?: boolean, withCredentials?: boolean, maxDataServiceVersion?: any, useBatch?: boolean, refreshAfterChange?: boolean, annotationURI?: string | any[], loadAnnotationsJoined?: boolean, serviceUrlParams?: any, metadataUrlParams?: any, defaultBindingMode?: sap.ui.model.BindingMode, defaultCountMode?: CountMode, preliminaryContext?: string, defaultOperationMode?: OperationMode, defaultUpdateMethod?: UpdateMethod, metadataNamespaces?: { [key: string]: string }, skipMetadataAnnotationParsing?: boolean, disableHeadRequestForToken?: boolean, sequentializeRequests?: boolean, disableSoftStateHeader?: boolean, bindableResponseHeaders?: any[], });
        ...
        */
        protected addAnnotationUrl(vUrl: string | any[]): any;
        ...
        */
        attachAnnotationsFailed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * An array of Errors */
            result: any[],
        ...
        /**
            * Attach event-handler `fnFunction` to the `annotationsFailed` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachAnnotationsFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * An array of Errors */
            result: any[],
        ...
        */
        attachAnnotationsLoaded<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * An array consisting of one or several annotation sources and/or errors containing a source property and error details. */
            result: any[],
        }>) => void, oListener?: Tcontext): this;
        ...
        /**
            * Attach event-handler `fnFunction` to the `annotationsLoaded` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachAnnotationsLoaded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * An array consisting of one or several annotation sources and/or errors containing a source property and error details. */
            result: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBatchRequestCompleted<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The request ID */
        ...
        /**
            * Attach event-handler `fnFunction` to the `batchRequestCompleted` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachBatchRequestCompleted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The request ID */
            ID: string, /* * The URL which is sent to the backend */
            url: string, /* * The HTTP method */
            method: string, /* * The request headers */
            headers: any, /* * Request was successful or not */
        ...
        */
        attachBatchRequestFailed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The request ID */
            ID: string, /* * The URL which is sent to the backend */
            url: string, /* * The HTTP method */
            method: string, /* * The request headers */
            ...
            response: any, /* * Array of embedded requests ($batch) Each request object within the array contains the following properties: url, method, headers, response object */
            requests: any[],
        }>) => void, oListener?: Tcontext): this;
        ...
        /**
            * Attach event-handler `fnFunction` to the `batchRequestFailed` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachBatchRequestFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The request ID */
            ID: string, /* * The URL which is sent to the backend */
            url: string, /* * The HTTP method */
            method: string, /* * The request headers */
            headers: any, /* * If the request is synchronous or asynchronous (if available) */
        ...
        */
        attachBatchRequestSent<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The URL which is sent to the backend */
        ...
        /**
            * Attach event-handler `fnFunction` to the `requestSent` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachBatchRequestSent<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The URL which is sent to the backend */
            url: string, /* * The type of the request (if available) */
            type?: string, /* * If the request is synchronous or asynchronous (if available) */
            async?: boolean, /* * Array of embedded requests ($batch) Each request object within the array contains the following properties: url, method, headers */
            requests: any[],
        ...
        */
        attachMetadataFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The parsed metadata */
        ...
        /**
            * Attach event-handler `fnFunction` to the `metadataFailed` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachMetadataFailed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The parsed metadata */
            metadata: string, /* * A text that describes the failure. */
            message: string, /* * HTTP status code returned by the request (if available) */
            statusCode: string, /* * The status as a text, details not specified, intended only for diagnosis output */
            statusText: string, /* * Response that has been received for the request, as a text string */
        ...
        */
        attachMetadataLoaded<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The parsed metadata */
            metadata: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        /**
            * Attach event-handler `fnFunction` to the `metadataLoaded` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachMetadataLoaded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The parsed metadata */
            metadata: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public bindContext(sPath: string, oContext: sap.ui.model.Context, mParameters?: any): sap.ui.model.ContextBinding;
        ...
        */
        public bindList(sPath: string, oContext?: sap.ui.model.Context, aSorters?: sap.ui.model.Sorter | any[], aFilters?: sap.ui.model.Filter | any[], mParameters?: { expand?: string, select?: string, custom?: any, countMode?: CountMode, operationMode?: OperationMode, faultTolerant?: boolean, batchGroupId?: string, threshold?: number, }): sap.ui.model.ListBinding;
        ...
        */
        public bindTree(sPath: string, oContext?: sap.ui.model.Context, aFilters?: sap.ui.model.Filter | any[], mParameters?: { treeAnnotationProperties?: any, navigation?: any, numberOfExpandedLevels?: number, rootLevel?: number, batchGroupId?: string, groupId?: string, operationMode?: OperationMode, threshold?: number, useServersideApplicationFilters?: boolean, treeState?: boolean, }, aSorters?: any[]): sap.ui.model.TreeBinding;
        ...
        */
        public callFunction(sFunctionName: string, mParameters?: { method?: string, urlParameters?: any, success?: Function, error?: Function, headers?: any, batchGroupId?: string, groupId?: string, eTag?: string, changeSetId?: string, refreshAfterChange?: string, }): any;
        ...
        */
        public create(sPath: string, oData: any, mParameters?: { context?: any, success?: Function, error?: Function, urlParameters?: any, headers?: any, batchGroupId?: string, groupId?: string, changeSetId?: string, refreshAfterChange?: string, }): any;
        ...
        */
        public createBindingContext(sPath: string, oContext?: any, mParameters?: { expand?: string, select?: string, preliminaryContext?: boolean, custom?: any, }, fnCallBack?: Function, bReload?: boolean): sap.ui.model.Context;
        ...
        */
        public createEntry(sPath: string, mParameters: { properties?: any[] | any, batchGroupId?: string, groupId?: string, changeSetId?: string, context?: sap.ui.model.Context, success?: Function, error?: Function, headers?: any, urlParameters?: any, refreshAfterChange?: string, }): sap.ui.model.Context;
        ...
        */
        public deleteCreatedEntry(oContext: sap.ui.model.Context): any;
        ...
        */
        public detachAnnotationsFailed(fnFunction: Function, oListener: any): this;

        /**
            * Detach event-handler `fnFunction` from the `annotationsLoaded` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        public detachAnnotationsLoaded(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachBatchRequestCompleted(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachBatchRequestFailed(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachBatchRequestSent(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachMetadataFailed(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachMetadataLoaded(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireBatchRequestCompleted(mArguments: { ID: string, url: string, method: string, headers: any, success: boolean, async: boolean, requests: any[], response: any, }): this;

        /**
            * Fire event `batchRequestFailed` to attached listeners.
        */
        protected fireBatchRequestFailed(mArguments: { ID: string, url: string, method: string, headers: any, async: boolean, success: boolean, response: any, requests: any[], }): this;
        ...
        */
        public getDefaultCountMode(): CountMode;
        ...
        */
        public getObject(sPath: string, oContext?: any, mParameters?: { select?: string, expand?: string, }): any;
        ...
        */
        public invalidate(fnCheckEntry?: Function): any;
        ...
        */
        public invalidateEntry(vEntry: string | sap.ui.model.Context): any;
        ...
        */
        public read(sPath: string, mParameters?: { context?: any, urlParameters?: any, filters?: any[], sorters?: any[], success?: Function, error?: Function, batchGroupId?: string, groupId?: string, }): any;
        ...
        */
        public remove(sPath: string, mParameters?: { context?: any, success?: Function, error?: Function, eTag?: string, urlParameters?: any, headers?: any, batchGroupId?: string, groupId?: string, changeSetId?: string, refreshAfterChange?: string, }): any;
        ...
        */
        public setDefaultCountMode(sCountMode: CountMode): any;
        ...
        */
        public setProperty(sPath: string, oValue: any, oContext?: sap.ui.model.Context, bAsyncUpdate?: boolean): boolean;
        ...
        */
        public submitChanges(mParameters?: { batchGroupId?: string, groupId?: string, success?: Function, error?: Function, eTag?: string, }): any;
        ...
        */
        public update(sPath: string, oData: any, mParameters?: { context?: any, success?: Function, error?: Function, eTag?: string, urlParameters?: any, headers?: any, batchGroupId?: string, groupId?: string, changeSetId?: string, refreshAfterChange?: string, }): any;
