declare module "sap/ui/model/odata/ODataListBinding" {
    ...
    */
    class ODataListBinding extends sap.ui.model.ListBinding {
        ...
        */
        public constructor(oModel: ODataModel, sPath: string, oContext: sap.ui.model.Context, aSorters?: any[], aFilters?: any[], mParameters?: { expand?: string, select?: string, custom?: any, countMode?: CountMode, });
        ...
        */
        public filter(aFilters: any[] | any[], sFilterType: sap.ui.model.FilterType): sap.ui.model.ListBinding;
