declare module "sap/ui/model/odata/v4/AnnotationHelper" {
    ...
    */
        export function getValueListType(vRawValue: any, oDetails: { context: sap.ui.model.Context, schemaChildName: string, }): ValueListType;/**
 ...
 * Examples: `&lt;template:if test="{facet>Target/$AnnotationPath@@sap.ui.model.odata.v4.AnnotationHelper.isMultiple}">`
    */
        export function isMultiple(sPath: string, oDetails: { context: sap.ui.model.Context, schemaChildName: string, }): boolean;/**
 ...
 * Example: `&lt;Label text="{meta>@@sap.ui.model.odata.v4.AnnotationHelper.label}" />`
    */
        export function label(vRawValue: any, oDetails: { context: sap.ui.model.Context, }): string;/**
