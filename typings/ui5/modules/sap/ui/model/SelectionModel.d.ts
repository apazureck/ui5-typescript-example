declare module "sap/ui/model/SelectionModel" {
    ...
    export default class SelectionModel extends sap.ui.base.EventProvider {
        ...
        */
         ...
         * 
        */
        public attachSelectionChanged(oData: any, fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'selectionChanged' event of this `sap.ui.model.SelectionModel`.
         * 
        */
        public attachSelectionChanged(fnFunction: Function, oListener?: any): this;
        ...
        */
        protected fireSelectionChanged(mArguments: { leadIndex: number, rowIndices?: any[], }): this;
