declare module "sap/ui/demokit/CodeSampleContainer" {
    ...
    */
    export default class CodeSampleContainer extends sap.ui.core.Control {
        ...
        */
        attachApply<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * the current code that will be applied */
            code: string,
         ...
         * Fired when the user decides to apply his/her changes to the sample code
        */
        attachApply<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * the current code that will be applied */
            code: string,
        ...
        */
        public detachApply(fnFunction: Function, oListener: any): this;
