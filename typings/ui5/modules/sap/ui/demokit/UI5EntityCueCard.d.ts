declare module "sap/ui/demokit/UI5EntityCueCard" {
    ...
    */
    class UI5EntityCueCard extends sap.ui.core.Control {
        ...
        */
        attachNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Name of the entity (control or type) that has been clicked. */
            entityName: string,
         ...
         * The default behavior for this event is to set the entityName property to the clicked entityName. Applications can prevent the default by calling the corresponding method on the event object.
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Name of the entity (control or type) that has been clicked. */
            entityName: string,
