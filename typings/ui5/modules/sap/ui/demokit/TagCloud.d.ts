declare module "sap/ui/demokit/TagCloud" {
    ...
    */
    class TagCloud extends sap.ui.core.Control {
        ...
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the selected Tag. */
            tagId: string,
         ...
         * Fired when a Tag is clicked.
        */
        attachPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the selected Tag. */
            tagId: string,
