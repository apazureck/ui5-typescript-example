declare module "sap/ui/layout/Splitter" {
    ...
    */
    export default class Splitter extends sap.ui.core.Control {
        ...
        */
        public addContentArea(oContentArea: sap.ui.core.Control): this;
        ...
        */
        attachResize<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the splitter control. The splitter control can also be accessed by calling getSource() on the event. */
            id: string, /* * An array of values representing the old (pixel-)sizes of the splitter contents */
            oldSizes: any[], /* * An array of values representing the new (pixel-)sizes of the splitter contents */
            newSizes: any[],
         ...
         * Event is fired when contents are resized.
        */
        attachResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The ID of the splitter control. The splitter control can also be accessed by calling getSource() on the event. */
            id: string, /* * An array of values representing the old (pixel-)sizes of the splitter contents */
            oldSizes: any[], /* * An array of values representing the new (pixel-)sizes of the splitter contents */
            newSizes: any[],
        ...
        */
        protected fireResize(mParameters?: { id?: string, oldSizes?: any[], newSizes?: any[], }): this;

        /**
            * Returns the current actual content sizes as pixel value - these values can change with every resize.
        */
        protected getCalculatedSizes(): any[];
        ...
        */
        public insertContentArea(oContentArea: sap.ui.core.Control, iIndex: number): this;
        ...
        */
        public removeAllContentAreas(): any[];
