declare module "sap/uxap/ObjectPageHeader" {
    ...
    */
    export default class ObjectPageHeader extends sap.ui.core.Control {
        ...
        */
        attachMarkChangesPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the changed item's icon to be used for positioning. */
            domRef: string,
         ...
         * The event is fired when the unsaved changes button is pressed
        */
        attachMarkChangesPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the changed item's icon to be used for positioning. */
            domRef: string,
        ...
        */
        attachMarkLockedPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the lock item's icon to be used for positioning. */
            domRef: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * The event is fired when the Locked button is pressed
        */
        attachMarkLockedPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the lock item's icon to be used for positioning. */
            domRef: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachTitleSelectorPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the title item's icon to be used for positioning. */
            domRef: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * The event is fired when the objectPage header title selector (down-arrow) is pressed
        */
        attachTitleSelectorPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the title item's icon to be used for positioning. */
            domRef: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachMarkChangesPress(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachMarkLockedPress(fnFunction: Function, oListener: any): this;
        ...
        */
        public getBreadCrumbsLinks(): any[];
        ...
        */
        public getHeaderDesign(): ObjectPageHeaderDesign;
        ...
        */
        public getObjectImageShape(): ObjectPageHeaderPictureShape;
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllBreadCrumbsLinks(): any[];
        ...
        */
         ...
         * Default value is `Light`.
        */
        public setHeaderDesign(sHeaderDesign: ObjectPageHeaderDesign): this;
        ...
        */
         ...
         * Default value is `Square`.
        */
        public setObjectImageShape(sObjectImageShape: ObjectPageHeaderPictureShape): this;
