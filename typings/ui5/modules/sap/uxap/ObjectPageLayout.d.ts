declare module "sap/uxap/ObjectPageLayout" {
    ...
    */
    class ObjectPageLayout extends sap.ui.core.Control {
        ...
        */
        public addHeaderContent(oHeaderContent: sap.ui.core.Control): this;
        ...
        */
        attachEditHeaderButtonPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * The event is fired when the Edit Header button is pressed
        */
        attachEditHeaderButtonPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected section object. */
         ...
         * The event is fired when the selected section is changed using the navigation.
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected section object. */
            section: ObjectPageSection,
        ...
        */
        attachToggleAnchorBar<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * False indicates that the Anchor bar has just detached from the Header and became part of the scrolling area. True means that the Anchor bar has just snapped to the Header. */
            fixed: boolean,
        }>) => void, oListener?: Tcontext): this;
         ...
         * The event is fired when the Anchor bar is switched from moving to fixed or the other way round.
        */
        attachToggleAnchorBar<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * False indicates that the Anchor bar has just detached from the Header and became part of the scrolling area. True means that the Anchor bar has just snapped to the Header. */
            fixed: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachEditHeaderButtonPress(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachToggleAnchorBar(fnFunction: Function, oListener: any): this;
        ...
        */
        public getHeaderTitle(): IHeaderTitle;
        ...
        */
        public getSubSectionLayout(): ObjectPageSubSectionLayout;
        ...
        */
        public insertHeaderContent(oHeaderContent: sap.ui.core.Control, iIndex: number): this;
        ...
        */
        public removeAllHeaderContent(): any[];
        ...
        */
        public setFooter(oFooter: IBar): this;
        ...
        */
        public setHeaderTitle(oHeaderTitle: IHeaderTitle): this;
        ...
        */
         ...
         * Default value is `TitleOnTop`.
        */
        public setSubSectionLayout(sSubSectionLayout: ObjectPageSubSectionLayout): this;
