declare module "sap/m/SelectList" {
    ...
    */
    export default class SelectList extends sap.ui.core.Control {
        ...
        */
        attachItemPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The pressed item. */
            item: Item,
         ...
         * This event is fired when an item is pressed.
        */
        attachItemPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The pressed item. */
            item: Item,
        ...
        */
        attachSelectionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected item. */
            selectedItem: Item,
        }>) => void, oListener?: Tcontext): this;
         ...
         * ** Note: ** The selection can be changed by pressing a non-selected item or via keyboard and after the enter or space key is pressed.
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected item. */
            selectedItem: Item,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        protected getDefaultSelectedItem(aItems?: any[]): Item | any;
        ...
        */
        public getKeyboardNavigationMode(): SelectListKeyboardNavigationMode;
        ...
        */
         ...
         * Default value is `Delimited`.
        */
        public setKeyboardNavigationMode(sKeyboardNavigationMode: SelectListKeyboardNavigationMode): this;
