declare module "sap/m/PagingButton" {
    ...
    */
    class PagingButton extends sap.ui.core.Control {
        ...
        */
        attachPositionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The number of the new position. */
         ...
         * Fired when the current position is changed.
        */
        attachPositionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The number of the new position. */
            newPosition: number, /* * The number of the old position. */
            oldPosition: number,
        ...
        */
        public detachPositionChange(fnFunction: Function, oListener: any): this;
