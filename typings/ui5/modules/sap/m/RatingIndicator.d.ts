declare module "sap/m/RatingIndicator" {
    ...
    type RatingIndicatorVisualMode = sapmlibrary.RatingIndicatorVisualMode;
    ...
    */
    class RatingIndicator extends sap.ui.core.Control {
        ...
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The rated value */
            value: number,
         ...
         * The event is fired when the user has done a rating.
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The rated value */
            value: number,
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the rating after a live change event. */
            value: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * This event is triggered during the dragging period, each time the rating value changes.
        */
        attachLiveChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the rating after a live change event. */
            value: number,
        }>) => void, oListener?: Tcontext): this;
