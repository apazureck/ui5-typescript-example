declare module "sap/m/Dialog" {
    ...
    */
    class Dialog extends sap.ui.core.Control {
        ...
        */
        attachAfterClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This indicates the trigger of closing the dialog. If dialog is closed by either leftButton or rightButton, the button that closes the dialog is set to this parameter. Otherwise this parameter is set to null. */
            origin: Button,
         ...
         * This event will be fired after the dialog is closed.
        */
        attachAfterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This indicates the trigger of closing the dialog. If dialog is closed by either leftButton or rightButton, the button that closes the dialog is set to this parameter. Otherwise this parameter is set to null. */
            origin: Button,
        ...
        */
        attachBeforeClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This indicates the trigger of closing the dialog. If dialog is closed by either leftButton or rightButton, the button that closes the dialog is set to this parameter. Otherwise this parameter is set to null. */
            origin: Button,
        }>) => void, oListener?: Tcontext): this;
         ...
         * This event will be fired before the dialog is closed.
        */
        attachBeforeClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This indicates the trigger of closing the dialog. If dialog is closed by either leftButton or rightButton, the button that closes the dialog is set to this parameter. Otherwise this parameter is set to null. */
            origin: Button,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public setType(sType: DialogType): this;
