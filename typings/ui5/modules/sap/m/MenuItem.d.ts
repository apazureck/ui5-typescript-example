declare module "sap/m/MenuItem" {
    ...
    */
    class MenuItem extends Item {
        ...
        */
        attachAggregationChanged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The aggregation name of the changed aggregation. */
         ...
         * Fired when aggregation of the item changes.
        */
        attachAggregationChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The aggregation name of the changed aggregation. */
            aggregationName: string, /* * Which method changed the aggregation. */
            methodName: string, /* * What parameters were used to change the aggregation. */
            methodParams: any,
        ...
        */
        attachPropertyChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The property name to be changed. */
         ...
         * Fired when a property of the item changes.
        */
        attachPropertyChanged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The property name to be changed. */
            propertyKey: string, /* * The new property value. */
            propertyValue: any,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachAggregationChanged(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireAggregationChanged(mParameters?: { aggregationName?: string, methodName?: string, methodParams?: any, }): this;
