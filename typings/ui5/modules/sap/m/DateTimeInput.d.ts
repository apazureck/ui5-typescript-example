declare module "sap/m/DateTimeInput" {
    ...
    */
    class DateTimeInput extends sap.ui.core.Control {
        ...
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The string value of the control in given valueFormat (or locale format). */
            value: string, /* * The value of control as JavaScript Date Object or null if value is empty. */
            dateValue: any, /* * if set, the entered value is a valid date. If not set the entered value cannot be converted to a date. */
            valid: boolean,
         ...
         * This event gets fired when the selection has finished and the value has changed.
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The string value of the control in given valueFormat (or locale format). */
            value: string, /* * The value of control as JavaScript Date Object or null if value is empty. */
            dateValue: any, /* * if set, the entered value is a valid date. If not set the entered value cannot be converted to a date. */
            valid: boolean,
        ...
        */
        protected fireChange(mParameters?: { value?: string, dateValue?: any, valid?: boolean, }): this;
        ...
        */
         ...
         * Default value is `Date`.
        */
        public setType(sType: DateTimeInputType): this;
