declare module "sap/m/Select" {
    ...
    */
    export default class Select extends sap.ui.core.Control {
        ...
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected item. */
            selectedItem: Item,
         ...
         * This event is fired when the value in the selection field is changed in combination with one of the following actions:  * The focus leaves the selection field * The * Enter * key is pressed * The item is pressed 
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected item. */
            selectedItem: Item,
        ...
        */
         ...
         * Default value is `Default`.
        */
        public setType(sType: SelectType): this;
