declare module "sap/m/Carousel" {
    ...
    */
    export default class Carousel extends sap.ui.core.Control {
        ...
        */
        attachLoadPage<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the page which will be loaded */
            pageId: string,
         ...
         * Carousel requires a new page to be loaded. This event may be used to fill the content of that page
        */
        attachLoadPage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the page which will be loaded */
            pageId: string,
        ...
        */
        attachPageChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the page which was active before the page change. */
         ...
         * This event is fired after a carousel swipe has been completed. It is triggered both by physical swipe events and through API carousel manipulations such as calling 'next', 'previous' or 'setActivePageId' functions.
        */
        attachPageChanged<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the page which was active before the page change. */
            oldActivePageId: string, /* * Id of the page which is active after the page change. */
            newActivePageId: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachUnloadPage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the page which will be unloaded */
            pageId: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Carousel does not display a page any longer and unloads it. This event may be used to clean up the content of that page.
        */
        attachUnloadPage<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Id of the page which will be unloaded */
            pageId: string,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachLoadPage(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachPageChanged(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachUnloadPage(fnFunction: Function, oListener: any): this;
        ...
        */
        public getArrowsPlacement(): CarouselArrowsPlacement;
        ...
        */
        public getPageIndicatorPlacement(): PlacementType;
        ...
        */
        public setActivePage(oActivePage: sap.ui.core.ID | sap.ui.core.Control): this;
         ...
         * Default value is `Content`.
        */
        public setArrowsPlacement(sArrowsPlacement: CarouselArrowsPlacement): this;
        ...
        */
         ...
         * Default value is `Bottom`.
        */
        public setPageIndicatorPlacement(sPageIndicatorPlacement: PlacementType): this;
