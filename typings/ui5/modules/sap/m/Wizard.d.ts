declare module "sap/m/Wizard" {
    ...
    */
    class Wizard extends sap.ui.core.Control {
        ...
        */
        attachStepActivate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The index of the activated step as a parameter. One-based. */
            index: number,
         ...
         * The StepActivated event is fired every time a new step is activated.
        */
        attachStepActivate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The index of the activated step as a parameter. One-based. */
            index: number,
