declare module "sap/m/RadioButtonGroup" {
    ...
    */
    export default class RadioButtonGroup extends sap.ui.core.Control {
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Index of the selected RadioButton. */
         ...
         * Fires when selection is changed by user interaction.
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Index of the selected RadioButton. */
            selectedIndex: number,
        ...
        */
        public bindButtons(oBindingInfo: any): this;
