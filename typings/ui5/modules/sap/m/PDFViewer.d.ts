declare module "sap/m/PDFViewer" {
    ...
    */
    export default class PDFViewer extends sap.ui.core.Control {
        ...
        */
        attachLoaded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * This event is fired when a PDF file is loaded. If the PDF is loaded in smaller chunks, this event is fired as often as defined by the browser's plugin. This may happen after a couple chunks are processed.
        */
        attachLoaded<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachSourceValidationFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * This event is fired when the PDF viewer control cannot check the loaded content. For example, the default configuration of the Mozilla Firefox browser may not allow checking the loaded content. This may also happen when the source PDF file is stored in a different domain. If you want no error message to be displayed when this event is fired, call the preventDefault() method inside the event handler.
        */
        attachSourceValidationFailed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachSourceValidationFailed(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireLoaded(mParameters?: any): this;

        /**
            * Fires event {@link #event:sourceValidationFailed sourceValidationFailed} to attached listeners.
        */
        protected fireSourceValidationFailed(mParameters?: any): this;
        ...
        */
        public removeAllPopupButtons(): any[];
        ...
        */
        public setErrorPlaceholder(oErrorPlaceholder: sap.ui.core.Control): this;
