declare module "sap/m/Slider" {
    ...
    */
    class Slider extends sap.ui.core.Control {
        ...
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the slider after a change. */
            value: number,
         ...
         * This event is triggered after the end user finishes interacting, if there is any change.
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the slider after a change. */
            value: number,
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the slider after a live change. */
            value: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * This event is triggered during the dragging period, each time the slider value changes.
        */
        attachLiveChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value of the slider after a live change. */
            value: number,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public setScale(oScale: IScale): this;
        ...
        */
         ...
         * Default value is `0`.
        */
        public setValue(fNewValue: number, mOptions: any): this;
