declare module "sap/m/GenericTile" {
    ...
    */
    class GenericTile extends sap.ui.core.Control {
        ...
        */
        attachPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current scope the GenericTile was in when the event occurred. */
            scope: GenericTileScope, /* * The action that was pressed on the tile. In the Actions scope, the available actions are Press and Remove. In Display scope, the parameter value is only Press. */
         ...
         * The event is triggered when the user presses the tile.
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current scope the GenericTile was in when the event occurred. */
            scope: GenericTileScope, /* * The action that was pressed on the tile. In the Actions scope, the available actions are Press and Remove. In Display scope, the parameter value is only Press. */
            action: string, /* * The pressed DOM Element pointing to the GenericTile's DOM Element in Display scope. In Actions scope it points to the more icon, when the tile is pressed, or to the DOM Element of the remove button, when the remove button is pressed. */
            domRef: any,
        ...
        */
        public bindTileContent(oBindingInfo: any): this;
        ...
        */
        public getMode(): GenericTileMode;
        ...
        */
        public removeAllTileContent(): any[];
        ...
        */
        public setIcon(oIcon: sap.ui.core.Control): this;
        ...
        */
         ...
         * Default value is `ContentMode`.
        */
        public setMode(sMode: GenericTileMode): this;
        ...
        */
         ...
         * Default value is `Loaded`.
        */
        public setState(sState: LoadState): this;
