declare module "sap/m/TextArea" {
    ...
    */
    export default class TextArea extends InputBase {
        ...
        */
        attachLiveChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new <code>value</code> of the control. */
            value: string,
         ...
         * Is fired whenever the user has modified the text shown on the text area.
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new <code>value</code> of the control. */
            value: string,
