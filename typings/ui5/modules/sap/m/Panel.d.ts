declare module "sap/m/Panel" {
    ...
    */
    export default class Panel extends sap.ui.core.Control {
        ...
        */
        attachExpand<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * If the panel will expand, this is true. If the panel will collapse, this is false. */
         ...
         * Indicates that the panel will expand or collapse.
        */
        attachExpand<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * If the panel will expand, this is true. If the panel will collapse, this is false. */
            expand: boolean, /* * Identifies whether the event is triggered by an user interaction or by calling setExpanded. */
            triggeredByInteraction: boolean,
        ...
        */
        public getAccessibleRole(): PanelAccessibleRole;
        ...
        */
        public setAccessibleRole(sRole: PanelAccessibleRole): this;
