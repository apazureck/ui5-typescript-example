declare module "sap/m/PullToRefresh" {
    ...
    */
    export default class PullToRefresh extends sap.ui.core.Control {
        ...
        */
        attachRefresh<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Event indicates that the user has requested new data
        */
        attachRefresh<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachRefresh(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireRefresh(mParameters?: any): this;
