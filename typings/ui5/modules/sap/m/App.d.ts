declare module "sap/m/App" {
    ...
    */
    export default class App extends NavContainer {
        ...
        */
        attachOrientationChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Whether the device is in landscape orientation. */
            landscape: boolean,
         ...
         * Fired when the orientation (portrait/landscape) of the device is changed.
        */
        attachOrientationChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Whether the device is in landscape orientation. */
            landscape: boolean,
