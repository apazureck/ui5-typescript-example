declare module "sap/m/MenuButton" {
    ...
    */
    class MenuButton extends sap.ui.core.Control {
        ...
        */
        attachDefaultAction<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fired when the `buttonMode` is set to `Split` and the user presses the main button unless `useDefaultActionOnly` is set to `false` and another action from the menu has been selected previously.
        */
        attachDefaultAction<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachDefaultAction(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireDefaultAction(mParameters?: any): this;
        ...
        */
        public getButtonMode(): MenuButtonMode;
        ...
        */
        public setButtonMode(sMode: MenuButtonMode): this;
        ...
        */
        public setTooltip(vTooltip: sap.ui.core.TooltipBase): any;
