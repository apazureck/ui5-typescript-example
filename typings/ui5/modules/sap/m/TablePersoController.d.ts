declare module "sap/m/TablePersoController" {
    ...
    */
    class TablePersoController extends sap.ui.base.ManagedObject {
        ...
        */
        attachPersonalizationsDone<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified, otherwise it will be bound to this `sap.m.TablePersoController` itself.
        */
        attachPersonalizationsDone<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachPersonalizationsDone(fnFunction: Function, oListener: any): this;
        ...
        */
        protected firePersonalizationsDone(mParameters?: any): this;
