declare module "sap/m/SplitApp" {
    ...
    */
    export default class SplitApp extends SplitContainer {
        ...
        */
        attachOrientationChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Returns true if the device is in landscape mode. */
            landscape: boolean,
         ...
         * Fires when orientation (portrait/landscape) is changed.
        */
        attachOrientationChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Returns true if the device is in landscape mode. */
            landscape: boolean,
        ...
        */
        public detachOrientationChange(fnFunction: Function, oListener: any): this;
