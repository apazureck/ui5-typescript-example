declare module "sap/m/SplitContainer" {
    ...
    */
    export default class SplitContainer extends sap.ui.core.Control {
        ...
        */
        public addDetailPage(oDetailPage: sap.ui.core.Control): this;

        /**
            * Adds some masterPage to the aggregation {@link #getMasterPages masterPages}.
        */
        public addMasterPage(oMasterPage: sap.ui.core.Control): this;
        ...
        */
        public addPage(oPage: sap.ui.core.Control, bMaster: boolean): this;
        ...
        */
        attachAfterDetailNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which had been displayed before navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which had been displayed before navigation. */
            fromId: string, /* * The page, which is now displayed after navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which is now displayed after navigation. */
         ...
         * Fires when navigation between two pages in detail area has completed. NOTE: In case of animated transitions this event is fired with some delay after the "navigate" event.
        */
        attachAfterDetailNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which had been displayed before navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which had been displayed before navigation. */
            fromId: string, /* * The page, which is now displayed after navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which is now displayed after navigation. */
            toId: string, /* * Determines whether the "to" page (more precisely: a control with the ID of the page, which has been navigated to) has not been displayed/navigated to before. */
        ...
        */
        attachAfterMasterClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fires when the master area is fully closed after the animation (if any).
        */
        attachAfterMasterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachAfterMasterNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which had been displayed before navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which had been displayed before navigation. */
            fromId: string, /* * The page, which is now displayed after navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which is now displayed after navigation. */
         ...
         * Fires when navigation between two pages in master area has completed. NOTE: In case of animated transitions this event is fired with some delay after the navigate event.
        */
        attachAfterMasterNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which had been displayed before navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which had been displayed before navigation. */
            fromId: string, /* * The page, which is now displayed after navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which is now displayed after navigation. */
            toId: string, /* * Whether the "to" page (more precisely: a control with the ID of the page, which has been navigated to) has not been displayed/navigated to before. */
        ...
        */
        attachAfterMasterOpen<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fires when the master area is fully opened after animation if any.
        */
        attachAfterMasterOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBeforeMasterClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fires before the master area is closed.
        */
        attachBeforeMasterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBeforeMasterOpen<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fires before the master area is opened.
        */
        attachBeforeMasterOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachDetailNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which was displayed before the current navigation. */
         ...
         * Fires when navigation between two pages in detail area has been triggered. The transition (if any) to the new page has not started yet. NOTE: This event can be aborted by the application with preventDefault(), which means that there will be no navigation.
        */
        attachDetailNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which was displayed before the current navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which was displayed before the current navigation. */
            fromId: string, /* * The page, which will be displayed after the current navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which will be displayed after the current navigation. */
            toId: string, /* * Determines whether the "to" page (more precisely: a control with the ID of the page, which is currently navigated to) has not been displayed/navigated to before. */
        ...
        */
        attachMasterButton<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Fires when a Master Button needs to be shown or hidden. This is necessary for custom headers when the SplitContainer control does not handle the placement of the master button automatically.
        */
        attachMasterButton<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        attachMasterNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which was displayed before the current navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which was displayed before the current navigation. */
            fromId: string, /* * The page, which will be displayed after the current navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which will be displayed after the current navigation. */
         ...
         * Fires when navigation between two pages in master area has been triggered. The transition (if any) to the new page has not started yet. This event can be aborted by the application with preventDefault(), which means that there will be no navigation.
        */
        attachMasterNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page, which was displayed before the current navigation. */
            from: sap.ui.core.Control, /* * The ID of the page, which was displayed before the current navigation. */
            fromId: string, /* * The page, which will be displayed after the current navigation. */
            to: sap.ui.core.Control, /* * The ID of the page, which will be displayed after the current navigation. */
            toId: string, /* * Determines whether the "to" page (more precisely: a control with the ID of the page, which is currently being navigated to) has not been displayed/navigated to before. */
        ...
        */
        public backDetail(oBackData: any, oTransitionParameter: any): this;

        /**
            * Navigates back to the previous master page which is found in the history.
        */
        public backMaster(oBackData: any, oTransitionParameter: any): this;
        ...
        */
        public backToPage(sPageId: string, oBackData: any, oTransitionParameters: any): this;
        ...
        */
        public detachAfterDetailNavigate(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachAfterMasterClose(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachAfterMasterNavigate(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachAfterMasterOpen(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachBeforeMasterClose(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachBeforeMasterOpen(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachDetailNavigate(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachMasterButton(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachMasterNavigate(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireAfterDetailNavigate(mParameters?: { from?: sap.ui.core.Control, fromId?: string, to?: sap.ui.core.Control, toId?: string, firstTime?: boolean, isTo?: boolean, isBack?: boolean, isBackToTop?: boolean, isBackToPage?: boolean, direction?: string, }): this;

        /**
            * Fires event {@link #event:afterMasterClose afterMasterClose} to attached listeners.
        */
        protected fireAfterMasterClose(mParameters?: any): this;

        /**
            * Fires event {@link #event:afterMasterNavigate afterMasterNavigate} to attached listeners.
        */
        protected fireAfterMasterNavigate(mParameters?: { from?: sap.ui.core.Control, fromId?: string, to?: sap.ui.core.Control, toId?: string, firstTime?: boolean, isTo?: boolean, isBack?: boolean, isBackToTop?: boolean, isBackToPage?: boolean, direction?: string, }): this;

        /**
            * Fires event {@link #event:afterMasterOpen afterMasterOpen} to attached listeners.
        */
        protected fireAfterMasterOpen(mParameters?: any): this;

        /**
            * Fires event {@link #event:beforeMasterClose beforeMasterClose} to attached listeners.
        */
        protected fireBeforeMasterClose(mParameters?: any): this;

        /**
            * Fires event {@link #event:beforeMasterOpen beforeMasterOpen} to attached listeners.
        */
        protected fireBeforeMasterOpen(mParameters?: any): this;
        ...
        */
        protected fireDetailNavigate(mParameters?: { from?: sap.ui.core.Control, fromId?: string, to?: sap.ui.core.Control, toId?: string, firstTime?: boolean, isTo?: boolean, isBack?: boolean, isBackToTop?: boolean, isBackToPage?: boolean, direction?: string, }): boolean;

        /**
            * Fires event {@link #event:masterButton masterButton} to attached listeners.
        */
        protected fireMasterButton(mParameters?: any): this;
         ...
         * Listeners may prevent the default action of this event by using the `preventDefault`-method on the event object.
        */
        protected fireMasterNavigate(mParameters?: { from?: sap.ui.core.Control, fromId?: string, to?: sap.ui.core.Control, toId?: string, firstTime?: boolean, isTo?: boolean, isBack?: boolean, isBackToTop?: boolean, isBackToPage?: boolean, direction?: string, }): boolean;
        ...
        */
        public insertDetailPage(oDetailPage: sap.ui.core.Control, iIndex: number): this;

        /**
            * Inserts a masterPage into the aggregation {@link #getMasterPages masterPages}.
        */
        public insertMasterPage(oMasterPage: sap.ui.core.Control, iIndex: number): this;
        ...
        */
        public insertPreviousPage(sPageId: string, sTransitionName: string, oData: any): this;
        ...
        */
        public removeAllDetailPages(): any[];
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllMasterPages(): any[];
        ...
        */
        public setInitialDetail(oInitialDetail: sap.ui.core.ID | sap.ui.core.Control): this;

        /**
            * Sets the associated {@link #getInitialMaster initialMaster}.
        */
        public setInitialMaster(oInitialMaster: sap.ui.core.ID | sap.ui.core.Control): this;
        ...
        */
         ...
         * Default value is `ShowHideMode`.
        */
        public setMode(sMode: SplitAppMode): this;
        ...
        */
        public toDetail(sPageId: string, sTransitionName: string, oData: any, oTransitionParameter: any): this;
