declare module "sap/m/TileContainer" {
    ...
    */
    export default class TileContainer extends sap.ui.core.Control {
        ...
        */
        attachTileAdd<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fires when a Tile is added.
        */
        attachTileAdd<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachTileDelete<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The deleted Tile. */
            tile: Tile,
         ...
         * Fires if a Tile is deleted in Edit mode.
        */
        attachTileDelete<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The deleted Tile. */
            tile: Tile,
        ...
        */
        attachTileMove<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The Tile that has been moved. */
         ...
         * Fires if a Tile is moved.
        */
        attachTileMove<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The Tile that has been moved. */
            tile: Tile, /* * The new index of the Tile in the tiles aggregation. */
            newIndex: number,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachTileAdd(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachTileDelete(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachTileMove(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireTileAdd(mParameters?: any): this;
