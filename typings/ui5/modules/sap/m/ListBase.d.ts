declare module "sap/m/ListBase" {
    ...
    */
    class ListBase extends sap.ui.core.Control {
        ...
        */
        attachDelete<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the delete event. */
         ...
         * Fires when delete icon is pressed by user.
        */
        attachDelete<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the delete event. */
            listItem: ListItemBase,
        ...
        */
        attachGrowingFinished<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Actual number of items. */
         ...
         * Fires after the new growing chunk has been fetched from the model and processed by the control.
        */
        attachGrowingFinished<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Actual number of items. */
            actual: number, /* * Total number of items. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachGrowingStarted<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Actual number of items. */
            actual: number, /* * Total number of items. */
            total: number,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fires before the new growing chunk is requested from the model.
        */
        attachGrowingStarted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Actual number of items. */
            actual: number, /* * Total number of items. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachItemPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the pressed event. */
         ...
         * Fires when an item is pressed unless the item's `type` property is `Inactive`.
        */
        attachItemPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the pressed event. */
            listItem: ListItemBase, /* * The control which caused the press event within the container. */
            srcControl: sap.ui.core.Control,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the select event. */
            listItem: ListItemBase,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fires when selection is changed via user interaction. In `MultiSelect` mode, this event is also fired on deselection.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the select event. */
            listItem: ListItemBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item whose selection has changed. In <code>MultiSelect</code> mode, only the up-most selected item is returned. This parameter can be used for single-selection modes. */
            ...
            listItems: any[], /* * Indicates whether the <code>listItem</code> parameter is selected or not. */
         ...
         * Fires when selection is changed via user interaction inside the control.
        */
        attachSelectionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item whose selection has changed. In <code>MultiSelect</code> mode, only the up-most selected item is returned. This parameter can be used for single-selection modes. */
            listItem: ListItemBase, /* * Array of items whose selection has changed. This parameter can be used for <code>MultiSelect</code> mode. */
            listItems: any[], /* * Indicates whether the <code>listItem</code> parameter is selected or not. */
            selected: boolean, /* * Indicates whether the select all action is triggered or not. */
            selectAll: boolean,
        ...
        */
        attachSwipe<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the swipe. */
            listItem: ListItemBase, /* * Aggregated <code>swipeContent</code> control that is shown on the right hand side of the item. */
            swipeContent: sap.ui.core.Control, /* * Holds which control caused the swipe event within the item. */
            srcControl: sap.ui.core.Control,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fires after user's swipe action and before the `swipeContent` is shown. On the `swipe` event handler, `swipeContent` can be changed according to the swiped item. Calling the `preventDefault` method of the event cancels the swipe action.
        */
        attachSwipe<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item which fired the swipe. */
            listItem: ListItemBase, /* * Aggregated <code>swipeContent</code> control that is shown on the right hand side of the item. */
            swipeContent: sap.ui.core.Control, /* * Holds which control caused the swipe event within the item. */
            srcControl: sap.ui.core.Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachUpdateFinished<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The reason of the update, e.g. Binding, Filter, Sort, Growing, Change, Refresh, Context. */
         ...
         * Fires after `items` binding is updated and processed by the control.
        */
        attachUpdateFinished<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The reason of the update, e.g. Binding, Filter, Sort, Growing, Change, Refresh, Context. */
            reason: string, /* * Actual number of items. */
            actual: number, /* * The total count of bound items. This can be used if the <code>growing</code> property is set to <code>true</code>. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachUpdateStarted<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The reason of the update, e.g. Binding, Filter, Sort, Growing, Change, Refresh, Context. */
            reason: string, /* * Actual number of items. */
            actual: number, /* * The total count of bound items. This can be used if the <code>growing</code> property is set to <code>true</code>. */
            total: number,
        }>) => void, oListener?: Tcontext): this;
         ...
         * ** Note: ** Event handler should not invalidate the control.
        */
        attachUpdateStarted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The reason of the update, e.g. Binding, Filter, Sort, Growing, Change, Refresh, Context. */
            reason: string, /* * Actual number of items. */
            actual: number, /* * The total count of bound items. This can be used if the <code>growing</code> property is set to <code>true</code>. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachGrowingFinished(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachGrowingStarted(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachItemPress(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachSwipe(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachUpdateFinished(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachUpdateStarted(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireItemPress(mParameters?: { listItem?: ListItemBase, srcControl?: sap.ui.core.Control, }): this;
        ...
        */
        protected fireSelectionChange(mParameters?: { listItem?: ListItemBase, listItems?: any[], selected?: boolean, selectAll?: boolean, }): this;
        ...
        */
        protected fireSwipe(mParameters?: { listItem?: ListItemBase, swipeContent?: sap.ui.core.Control, srcControl?: sap.ui.core.Control, }): boolean;
        ...
        */
        public getGrowingDirection(): ListGrowingDirection;
        ...
        */
        public getHeaderDesign(): ListHeaderDesign;
        ...
        */
        public getKeyboardMode(): ListKeyboardMode;
        ...
        */
        public getSwipeDirection(): SwipeDirection;
        ...
        */
         ...
         * Default value is `Downwards`.
        */
        public setGrowingDirection(sGrowingDirection: ListGrowingDirection): this;
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public setHeaderDesign(sHeaderDesign: ListHeaderDesign): this;
        ...
        */
         ...
         * Default value is `Navigation`.
        */
        public setKeyboardMode(sKeyboardMode: ListKeyboardMode): this;
        ...
        */
        public setSwipeContent(oSwipeContent: sap.ui.core.Control): this;
         ...
         * Default value is `Both`.
        */
        public setSwipeDirection(sSwipeDirection: SwipeDirection): this;
