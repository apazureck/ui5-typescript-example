declare module "sap/m/SelectionDetails" {
    ...
    */
    export default class SelectionDetails extends sap.ui.core.Control {
        ...
        */
        attachActionPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The action that has to be processed once the action has been pressed */
            ...
            level: SelectionDetailsActionLevel,
         ...
         * Event is triggered when a custom action is pressed.
        */
        attachActionPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The action that has to be processed once the action has been pressed */
            action: Item, /* * If the action is pressed on one of the {@link sap.m.SelectionDetailsItem items}, the parameter contains a reference to the pressed {@link sap.m.SelectionDetailsItem item}. If a custom action or action group of the SelectionDetails popover is pressed, this parameter refers to all {@link sap.m.SelectionDetailsItem items} */
            items: SelectionDetailsItem, /* * The action level of action buttons. The available levels are Item, List and Group */
            level: SelectionDetailsActionLevel,
        ...
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item on which the action has been pressed. Can be null in case a navigation was done without item context, e.g. action press. */
         ...
         * Event is triggered after a list item of {@link sap.m.SelectionDetailsItem} is pressed.
        */
        attachNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item on which the action has been pressed. Can be null in case a navigation was done without item context, e.g. action press. */
            item: SelectionDetailsItem, /* * Direction of the triggered navigation, possible values are "to" and "back". */
            direction: string, /* * The content of the currently viewed page that was previously added via {@link sap.m.SelectionDetails#navTo}. This contains the content of the page before the navigation was triggered. Can be null in case of first event triggering. */
            content: sap.ui.core.Control,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        protected attachSelectionHandler(eventId: string, listener: any): this;
        ...
        */
        public detachActionPress(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireActionPress(mParameters?: { action?: Item, items?: SelectionDetailsItem, level?: SelectionDetailsActionLevel, }): this;
        ...
        */
        protected fireNavigate(mParameters?: { item?: SelectionDetailsItem, direction?: string, content?: sap.ui.core.Control, }): this;
        ...
        */
        protected registerSelectionDetailsItemFactory(data: any, factory: Function): this;
