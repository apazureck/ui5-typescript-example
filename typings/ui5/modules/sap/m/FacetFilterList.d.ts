declare module "sap/m/FacetFilterList" {
    ...
    */
    class FacetFilterList extends List {
        ...
        */
        attachListClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Array of selected items. Items returned are only copies and therefore can only be used to read properties, not set them. */
            selectedItems: any[], /* * <code>True</code> if the select All checkbox is selected. This will be <code>false</code> if all items are actually selected (every FacetFilterItem.selected == true). In that case selectedItems will contain all selected items. */
         ...
         * Triggered after the list of items is closed.
        */
        attachListClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Array of selected items. Items returned are only copies and therefore can only be used to read properties, not set them. */
            selectedItems: any[], /* * <code>True</code> if the select All checkbox is selected. This will be <code>false</code> if all items are actually selected (every FacetFilterItem.selected == true). In that case selectedItems will contain all selected items. */
            allSelected: boolean, /* * Associative array containing the keys of selected FacetFilterItems. Unlike the selectedItems parameter, this contains only the keys for all selected items, not the items themselves. Being an associative array, each object property is the FacetFilterItem key value and the value of the property is the FacetFilterItem text. */
            selectedKeys: any,
        ...
        */
        attachListOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * Fired before the filter list is opened.
        */
        attachListOpen<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachListClose(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachListOpen(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireListClose(mParameters?: { selectedItems?: any[], allSelected?: boolean, selectedKeys?: any, }): this;

        /**
            * Fires event {@link #event:listOpen listOpen} to attached listeners.
        */
        protected fireListOpen(mParameters?: any): this;
        ...
        */
        public getDataType(): FacetFilterListDataType;
        ...
        */
         ...
         * Default value is `String`.
        */
        public setDataType(sDataType: FacetFilterListDataType): this;
        ...
        */
        public setMode(mode: ListMode): this;
        ...
        */
        public setSelectedKeys(oKeys: any): any;
