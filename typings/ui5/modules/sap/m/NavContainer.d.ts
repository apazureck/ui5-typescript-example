declare module "sap/m/NavContainer" {
    ...
    */
    class NavContainer extends sap.ui.core.Control {
        ...
        */
        public addCustomTransition(sName: string, oTo: any, oBack: any): this;

        /**
            * Adds some page to the aggregation {@link #getPages pages}.
        */
        public addPage(oPage: sap.ui.core.Control): this;
        ...
        */
        attachAfterNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page which had been shown before navigation. */
            from: sap.ui.core.Control, /* * The ID of the page which had been shown before navigation. */
            fromId: string, /* * The page which is now shown after navigation. */
            to: sap.ui.core.Control, /* * The ID of the page which is now shown after navigation. */
         ...
         * The event is fired when navigation between two pages has completed. In case of animated transitions this event is fired with some delay after the "navigate" event.
        */
        attachAfterNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page which had been shown before navigation. */
            from: sap.ui.core.Control, /* * The ID of the page which had been shown before navigation. */
            fromId: string, /* * The page which is now shown after navigation. */
            to: sap.ui.core.Control, /* * The ID of the page which is now shown after navigation. */
            toId: string, /* * Whether the "to" page (more precisely: a control with the ID of the page which has been navigated to) had not been shown/navigated to before. */
        ...
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page which was shown before the current navigation. */
         ...
         * The event is fired when navigation between two pages has been triggered. The transition (if any) to the new page has not started yet. This event can be aborted by the application with preventDefault(), which means that there will be no navigation.
        */
        attachNavigate<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The page which was shown before the current navigation. */
            from: sap.ui.core.Control, /* * The ID of the page which was shown before the current navigation. */
            fromId: string, /* * The page which will be shown after the current navigation. */
            to: sap.ui.core.Control, /* * The ID of the page which will be shown after the current navigation. */
            toId: string, /* * Whether the "to" page (more precisely: a control with the ID of the page which is currently navigated to) has not been shown/navigated to before. */
        ...
        */
        public back(oBackData?: any, oTransitionParameters?: any): this;
        ...
        */
        public backToTop(oBackData?: any, oTransitionParameters?: any): this;
        ...
        */
        protected fireAfterNavigate(mParameters?: { from?: sap.ui.core.Control, fromId?: string, to?: sap.ui.core.Control, toId?: string, firstTime?: boolean, isTo?: boolean, isBack?: boolean, isBackToTop?: boolean, isBackToPage?: boolean, direction?: string, }): this;
        ...
        */
        protected fireNavigate(mParameters?: { from?: sap.ui.core.Control, fromId?: string, to?: sap.ui.core.Control, toId?: string, firstTime?: boolean, isTo?: boolean, isBack?: boolean, isBackToTop?: boolean, isBackToPage?: boolean, direction?: string, }): boolean;
        ...
        */
        public insertPage(oPage: sap.ui.core.Control, iIndex: number): this;
        ...
        */
        public setInitialPage(oInitialPage: sap.ui.core.ID | sap.ui.core.Control): this;
