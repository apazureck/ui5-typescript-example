declare module "sap/m/UploadCollection" {
    ...
    */
    class UploadCollection extends sap.ui.core.Control {
        ...
        */
        attachBeforeUploadStarts<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Specifies the name of the file to be uploaded. */
            fileName: string, /* * Adds a header parameter to the file that will be uploaded. */
            addHeaderParameter: Function, /* * Returns the corresponding header parameter (type sap.m.UploadCollectionParameter) if available. */
         ...
         * The event is triggered before the actual upload starts. An event is fired per file. All the necessary header parameters should be set here.
        */
        attachBeforeUploadStarts<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Specifies the name of the file to be uploaded. */
            fileName: string, /* * Adds a header parameter to the file that will be uploaded. */
            addHeaderParameter: Function, /* * Returns the corresponding header parameter (type sap.m.UploadCollectionParameter) if available. */
            getHeaderParameter: Function,
        ...
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
         ...
         * The event is triggered when files are selected in the FileUploader dialog. Applications can set parameters and headerParameters which will be dispatched to the embedded FileUploader control. Limitation: parameters and headerParameters are not supported by Internet Explorer 9.
        */
        attachChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            documentId: string, /* * A FileList of individually selected files from the underlying system. See www.w3.org for the FileList Interface definition. Limitation: Internet Explorer 9 supports only single file with property file.name. Since version 1.28.0. */
            files: any[],
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachFileDeleted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>item</code> parameter instead. */
         ...
         * The event is triggered when an uploaded attachment is selected and the Delete button is pressed.
        */
        attachFileDeleted<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>item</code> parameter instead. */
            documentId: string, /* * An item to be deleted from the collection. Since version 1.28.0. */
            item: UploadCollectionItem,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachFilenameLengthExceed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
         ...
         * The event is triggered when the name of a chosen file is longer than the value specified with the maximumFilenameLength property (only if provided by the application).
        */
        attachFilenameLengthExceed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            documentId: string, /* * A FileList of individually selected files from the underlying system. Limitation: Internet Explorer 9 supports only single file with property file.name. Since version 1.28.0. */
            files: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachFileRenamed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>item</code> parameter instead. */
         ...
         * The event is triggered when the file name is changed.
        */
        attachFileRenamed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>item</code> parameter instead. */
            documentId: string, /* * The new file name. This parameter is deprecated since 1.28.0. Use the <code>item</code> parameter instead. */
            fileName: string, /* * The renamed UI element as an UploadCollectionItem. Since 1.28.0. */
            item: UploadCollectionItem,
        }>) => void, oListener?: Tcontext): this;
        ...
        */
        attachFileSizeExceed<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
         ...
         * The event is triggered when the file size of an uploaded file is exceeded (only if the maxFileSize property was provided by the application). This event is not supported by Internet Explorer 9.
        */
        attachFileSizeExceed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            documentId: string, /* * The size in MB of a file to be uploaded. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            fileSize: string, /* * A FileList of individually selected files from the underlying system. Limitation: Internet Explorer 9 supports only single file with property file.name. Since 1.28.0. */
            files: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSelectionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item whose selection has changed. In <code>MultiSelect</code> mode, only the topmost selected item is returned. This parameter can be used for single-selection modes. */
            ...
            selectedItems: any[], /* * Indicates whether the <code>listItem</code> parameter is selected or not. */
            selected: boolean,
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fires when selection is changed via user interaction inside the control.
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The item whose selection has changed. In <code>MultiSelect</code> mode, only the topmost selected item is returned. This parameter can be used for single-selection modes. */
            selectedItem: UploadCollectionItem, /* * Array of items whose selection has changed. This parameter can be used for <code>MultiSelect</code> mode. */
            selectedItems: any[], /* * Indicates whether the <code>listItem</code> parameter is selected or not. */
            selected: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachTypeMissmatch<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
         ...
         * The event is triggered when the file type or the MIME type don't match the permitted types (only if the fileType property or the mimeType property are provided by the application).
        */
        attachTypeMissmatch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * A unique Id of the attached document. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            documentId: string, /* * File type. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            fileType: string, /* * MIME type. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            mimeType: string, /* * A FileList of individually selected files from the underlying system. Limitation: Internet Explorer 9 supports only single file. Since 1.28.0. */
            files: any[],
        ...
        */
        attachUploadComplete<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Ready state XHR. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
         ...
         * The event is triggered as soon as the upload request is completed.
        */
        attachUploadComplete<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Ready state XHR. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            readyStateXHR: string, /* * Response of the completed upload request. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            response: string, /* * Status Code of the completed upload event. This parameter is deprecated since 1.28.0. Use the <code>files</code> parameter instead. */
            status: string, /* * A list of uploaded files. Each entry contains the following members. fileName : The name of a file to be uploaded. response : Response message which comes from the server. On the server side, this response has to be put within the 'body' tags of the response document of the iFrame. It can consist of a return code and an optional message. This does not work in cross-domain scenarios. reponse : deprecated Since version 1.48.0. This parameter is deprecated, use parameter response instead. responseRaw : HTTP-Response which comes from the server. This property is not supported by Internet Explorer Versions lower than 9. status : Status of the XHR request. This property is not supported by Internet Explorer 9 and lower. headers : HTTP-Response-Headers which come from the server. Provided as a JSON-map, i.e. each header-field is reflected by a property in the header-object, with the property value reflecting the header-field's content. This property is not supported by Internet Explorer 9 and lower. Since 1.28.0. */
            files: any[],
        ...
        */
        attachUploadTerminated<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Specifies the name of the file of which the upload is to be terminated. */
         ...
         * The event is triggered as soon as the upload request was terminated by the user.
        */
        attachUploadTerminated<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Specifies the name of the file of which the upload is to be terminated. */
            fileName: string, /* * This callback function returns the corresponding header parameter (type sap.m.UploadCollectionParameter) if available. */
            getHeaderParameter: Function,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachBeforeUploadStarts(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFileDeleted(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFilenameLengthExceed(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFileRenamed(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFileSizeExceed(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachTypeMissmatch(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachUploadComplete(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachUploadTerminated(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireBeforeUploadStarts(mParameters?: { fileName?: string, addHeaderParameter?: Function, getHeaderParameter?: Function, }): this;

        /**
            * Fires event {@link #event:change change} to attached listeners.
        */
        protected fireChange(mParameters?: { documentId?: string, files?: any[], }): this;
        ...
        */
        protected fireFilenameLengthExceed(mParameters?: { documentId?: string, files?: any[], }): this;
        ...
        */
        protected fireFileSizeExceed(mParameters?: { documentId?: string, fileSize?: string, files?: any[], }): this;

        /**
            * Fires event {@link #event:selectionChange selectionChange} to attached listeners.
        */
        protected fireSelectionChange(mParameters?: { selectedItem?: UploadCollectionItem, selectedItems?: any[], selected?: boolean, }): this;

        /**
            * Fires event {@link #event:typeMissmatch typeMissmatch} to attached listeners.
        */
        protected fireTypeMissmatch(mParameters?: { documentId?: string, fileType?: string, mimeType?: string, files?: any[], }): this;

        /**
            * Fires event {@link #event:uploadComplete uploadComplete} to attached listeners.
        */
        protected fireUploadComplete(mParameters?: { readyStateXHR?: string, response?: string, status?: string, files?: any[], }): this;

        /**
            * Fires event {@link #event:uploadTerminated uploadTerminated} to attached listeners.
        */
        protected fireUploadTerminated(mParameters?: { fileName?: string, getHeaderParameter?: Function, }): this;
        ...
        */
        public getHeaderParameters(): any[];
        ...
        */
        public getInternalRequestHeaderNames(): any[];
        ...
        */
        public getShowSeparators(): ListSeparators;
        ...
        */
        public removeAllHeaderParameters(): any[];
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllParameters(): any[];
        ...
        */
        public setFileType(sFileType: any[]): this;
        ...
        */
         ...
         * When called with a value of `null` or `undefined`, the default value of the property will be restored.
        */
        public setMimeType(sMimeType: any[]): this;
         ...
         * Default value is `None`.
        */
        public setMode(sMode: ListMode): this;
        ...
        */
         ...
         * Default value is `All`.
        */
        public setShowSeparators(sShowSeparators: ListSeparators): this;
