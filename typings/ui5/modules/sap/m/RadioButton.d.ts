declare module "sap/m/RadioButton" {
    ...
    */
    class RadioButton extends sap.ui.core.Control {
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Checks whether the RadioButton is active or not. */
            selected: boolean,
         ...
         * Event is triggered when the user makes a change on the radio button (selecting or unselecting it).
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Checks whether the RadioButton is active or not. */
            selected: boolean,
        ...
        */
        public onsapselect(oEvent: any): any;
