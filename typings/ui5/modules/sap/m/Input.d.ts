    ...
    export default class Input extends InputBase {
        ...
        */
        ...
        /**
            * Adds aggregation.
        */
        protected addAggregation(sAggregationName: string, oObject: any, bSuppressInvalidate: boolean): this;
        ...
        */
        attachLiveChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new value of the input. */
         ...
         * This event is fired when the value of the input is changed - e.g. at each keypress
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new value of the input. */
            value: string, /* * Indicate that ESC key triggered the event. */
            escPressed: boolean, /* * The value of the input before pressing ESC key. */
            previousValue: string,
        ...
        */
        attachSubmit<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new value of the input. */
            value: string,
        }>) => void, oListener?: Tcontext): this;
         ...
         * ** Note: ** The event is fired independent of whether there was a change before or not. If a change was performed the event is fired after the change event. The event is also fired when an item of the select list is selected via `Enter`. The event is only fired on an input which allows text input (`editable`, `enabled` and not `valueHelpOnly`).
        */
        attachSubmit<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The new value of the input. */
            value: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSuggest<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value which has been typed in the input. */
         ...
         * This event is fired when user types in the input and showSuggestion is set to true. Changing the suggestItems aggregation will show the suggestions within a popup.
        */
        attachSuggest<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The current value which has been typed in the input. */
            suggestValue: string, /* * The suggestion list is passed to this event for convenience. If you use list-based or tabular suggestions, fill the suggestionList with the items you want to suggest. Otherwise, directly add the suggestions to the "suggestionItems" aggregation of the input control. */
            suggestionColumns: ListBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSuggestionItemSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This is the item selected in the suggestion popup for one and two-value suggestions. For tabular suggestions, this value will not be set. */
 ...
 * Note: The row result function to select a result value for the string is already executed at this time. To pick different value for the input field or to do follow up steps after the item has been selected. */
         ...
         * This event is fired when suggestionItem shown in suggestion popup are selected. This event is only fired when showSuggestion is set to true and there are suggestionItems shown in the suggestion popup.
        */
        attachSuggestionItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This is the item selected in the suggestion popup for one and two-value suggestions. For tabular suggestions, this value will not be set. */
            selectedItem: Item, /* * This is the row selected in the tabular suggestion popup represented as a ColumnListItem. For one and two-value suggestions, this value will not be set.
 * 
 * Note: The row result function to select a result value for the string is already executed at this time. To pick different value for the input field or to do follow up steps after the item has been selected. */
            selectedRow: ColumnListItem,
        ...
        */
        attachValueHelpRequest<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The event parameter is set to true, when the button at the end of the suggestion table is clicked, otherwise false. It can be used to determine whether the "value help" trigger or the "show all items" trigger has been pressed. */
        ...
        */
        public bindSuggestionColumns(oBindingInfo: any): this;
         ...
         * See {@link sap.ui.base.ManagedObject#bindAggregation ManagedObject.bindAggregation} for a detailed description of the possible properties of `oBindingInfo`.
        */
        public bindSuggestionRows(oBindingInfo: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachSuggest(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachSuggestionItemSelected(fnFunction: Function, oListener: any): this;
        ...
        */
        ...
        /**
            * Gets aggregation.
        */
        protected getAggregation(sAggregationName: string, oDefaultForCreation: any): any | sap.ui.base.ManagedObject | any[];

        /**
            * Gets binding.
        */
        public getBinding(sAggregationName: string): any | sap.ui.model.Binding;
        ...
        */
        public getSuggestionColumns(): any[];
        ...
        */
        public getTextFormatMode(): InputTextFormatMode;
        ...
        */
        ...
        /**
            * Inserts aggregation.
        */
        protected insertAggregation(sAggregationName: string, oObject: any, iIndex: number, bSuppressInvalidate: boolean): this;
        ...
        */
        ...
        /**
            * Removes aggregation.
        */
        protected removeAggregation(sAggregationName: string, oObject: any, bSuppressInvalidate: boolean): any | sap.ui.base.ManagedObject;
        ...
        */
        public removeAllSuggestionColumns(): any[];
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllSuggestionItems(): any[];
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllSuggestionRows(): any[];
        ...
        */
        public setRowResultFunction(fnFilter: Function): this;
        ...
        */
         ...
         * Default value is `Value`.
        */
        public setTextFormatMode(sTextFormatMode: InputTextFormatMode): this;
        ...
        */
         ...
         * Default value is `Text`.
        */
        public setType(sType: InputType): this;
        ...
        */
        protected validateAggregation(sAggregationName: string, oObject: any, bMultiple: boolean): any | sap.ui.base.ManagedObject;
