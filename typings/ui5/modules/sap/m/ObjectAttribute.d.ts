declare module "sap/m/ObjectAttribute" {
    ...
    */
    class ObjectAttribute extends sap.ui.core.Control {
        ...
        */
        attachPress<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the ObjectAttribute's text to be used for positioning. */
            domRef: string,
         ...
         * Fires when the user clicks on active text.
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * DOM reference of the ObjectAttribute's text to be used for positioning. */
            domRef: string,
        ...
        */
        public setCustomContent(oCustomContent: sap.ui.core.Control): this;
