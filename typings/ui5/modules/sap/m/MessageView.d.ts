declare module "sap/m/MessageView" {
    ...
    */
    class MessageView {
        ...
        */
        attachItemSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Refers to the message item that is being presented */
         ...
         * This event will be fired when description is shown
        */
        attachItemSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Refers to the message item that is being presented */
            item: MessageItem, /* * Refers to the type of messages being shown See sap.ui.core.MessageType values for types */
            messageTypeFilter: sap.ui.core.MessageType,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
