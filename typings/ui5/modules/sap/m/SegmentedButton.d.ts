declare module "sap/m/SegmentedButton" {
    ...
    */
    class SegmentedButton extends sap.ui.core.Control {
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Reference to the button, that has been selected. */
         ...
         * Fires when the user selects a button, which returns the ID and button object.
        */
        attachSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Reference to the button, that has been selected. */
            button: Button, /* * ID of the button, which has been selected. */
            id: string, /* * Key of the button, which has been selected. This property is only filled when the control is initiated with the items aggregation. */
            key: string,
        ...
        */
        attachSelectionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Reference to the item, that has been selected. */
         ...
         * Fires when the user selects an item, which returns the item object.
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Reference to the item, that has been selected. */
            item: SegmentedButtonItem,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public bindSelectedKey(oBindingInfo: any): this;
