declare module "sap/m/IconTabFilter" {
    ...
    */
    class IconTabFilter extends Item {
        ...
        */
        public getDesign(): IconTabFilterDesign;
        ...
        */
        protected render(rm: sap.ui.core.RenderManager, visibleIndex: number, visibleItemsCount: number): any;

        /**
            * Renders this item in the IconTabSelectList.
        */
        protected renderInSelectList(rm: sap.ui.core.RenderManager, selectList: sap.m.IconTabBarSelectList, visibleIndex: number, visibleItemsCount: number): any;
        ...
        */
         ...
         * Default value is `Vertical`.
        */
        public setDesign(sDesign: IconTabFilterDesign): this;
