declare module "sap/m/PlanningCalendar" {
    ...
    */
    class PlanningCalendar extends sap.ui.core.Control {
        ...
        */
        public addToolbarContent(oToolbarContent: sap.ui.core.Control): this;
        ...
        */
        attachAppointmentSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected appointment. */
            appointment: CalendarAppointment, /* * The selected appointments in case a group appointment is selected. */
            appointments: any[], /* * If set, the appointment was selected using multiple selection (e.g. Shift + single mouse click), meaning more than the current appointment could be selected. */
         ...
         * Fired if an appointment is selected.
        */
        attachAppointmentSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * The selected appointment. */
            appointment: CalendarAppointment, /* * The selected appointments in case a group appointment is selected. */
            appointments: any[], /* * If set, the appointment was selected using multiple selection (e.g. Shift + single mouse click), meaning more than the current appointment could be selected. */
            multiSelect: boolean, /* * Gives the ID of the DOM element of the clicked appointment */
            domRefId: string,
        ...
        */
        attachIntervalSelect<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Start date of the selected interval, as a JavaScript date object. */
            startDate: any, /* * Interval end date as a JavaScript date object. */
            endDate: any, /* * If set, the selected interval is a subinterval. */
         ...
         * Fired if an interval was selected in the calendar header or in the row.
        */
        attachIntervalSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Start date of the selected interval, as a JavaScript date object. */
            startDate: any, /* * Interval end date as a JavaScript date object. */
            endDate: any, /* * If set, the selected interval is a subinterval. */
            subInterval: boolean, /* * Row of the selected interval. */
            row: PlanningCalendarRow,
        ...
        */
        attachRowHeaderClick<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * Fires when a row header is clicked.
        */
        attachRowHeaderClick<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachRowSelectionChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Array of rows whose selection has changed. */
            rows: any[],
        }>) => void, oListener?: Tcontext): this;
         ...
         * Fires when row selection is changed.
        */
        attachRowSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * Array of rows whose selection has changed. */
            rows: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachStartDateChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * `startDate` was changed while navigating in the `PlanningCalendar`. The new value can be obtained using the `sap.m.PlanningCalendar#getStartDate()` method.
        */
        attachStartDateChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachViewChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * `viewKey` was changed by user interaction.
        */
        attachViewChange<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
        ...
        */
        public detachAppointmentSelect(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachIntervalSelect(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachRowHeaderClick(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachStartDateChange(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachViewChange(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireAppointmentSelect(mParameters?: { appointment?: CalendarAppointment, appointments?: any[], multiSelect?: boolean, domRefId?: string, }): this;

        /**
            * Fires event {@link #event:intervalSelect intervalSelect} to attached listeners.
        */
        protected fireIntervalSelect(mParameters?: { startDate?: any, endDate?: any, subInterval?: boolean, row?: PlanningCalendarRow, }): this;

        /**
            * Fires event {@link #event:rowHeaderClick rowHeaderClick} to attached listeners.
        */
        protected fireRowHeaderClick(mParameters?: any): this;

        /**
            * Fires event {@link #event:rowSelectionChange rowSelectionChange} to attached listeners.
        */
        protected fireRowSelectionChange(mParameters?: { rows?: any[], }): this;
        ...
        */
        protected fireViewChange(mParameters?: any): this;
        ...
        */
        public getAppointmentsVisualization(): CalendarAppointmentVisualization;
        ...
        */
        public getGroupAppointmentsMode(): GroupAppointmentsMode;
        ...
        */
        public insertToolbarContent(oToolbarContent: sap.ui.core.Control, iIndex: number): this;
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllToolbarContent(): any[];
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public setAppointmentsVisualization(sAppointmentsVisualization: CalendarAppointmentVisualization): this;
         ...
         * Default value is `[]`.
        */
        public setBuiltInViews(sBuiltInViews: any[]): this;
         ...
         * Default value is `Collapsed`.
        */
        public setGroupAppointmentsMode(sGroupAppointmentsMode: GroupAppointmentsMode): this;
