declare module "sap/m/Popover" {
    ...
    */
    export default class Popover extends sap.ui.core.Control {
        ...
        */
        attachAfterClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This refers to the control which opens the popover. */
         ...
         * This event will be fired after the popover is closed.
        */
        attachAfterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This refers to the control which opens the popover. */
            openBy: sap.ui.core.Control,
        ...
        */
        attachBeforeClose<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This refers to the control which opens the popover. */
            openBy: sap.ui.core.Control,
        }>) => void, oListener?: Tcontext): this;
         ...
         * This event will be fired before the popover is closed.
        */
        attachBeforeClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This refers to the control which opens the popover. */
            openBy: sap.ui.core.Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBeforeOpen<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This refers to the control which opens the popover. */
            openBy: sap.ui.core.Control,
        }>) => void, oListener?: Tcontext): this;
         ...
         * This event will be fired before the popover is opened.
        */
        attachBeforeOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, { /* * This refers to the control which opens the popover. */
            openBy: sap.ui.core.Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public openBy(oControl: any, bSkipInstanceManager: boolean): this;
        ...
        */
        public setBeginButton(oBeginButton: sap.ui.core.Control): this;
        ...
        */
        public setCustomHeader(oCustomHeader: sap.ui.core.Control): this;
        ...
        */
        public setEndButton(oEndButton: sap.ui.core.Control): this;
        ...
        */
        public setFooter(oFooter: sap.ui.core.Control): this;
        ...
        */
        public setSubHeader(oSubHeader: sap.ui.core.Control): this;
