declare module "sap/m/ComboBoxBase" {
    ...
    */
    class ComboBoxBase extends ComboBoxTextField {
        ...
        */
        attachLoadItems<Tcontext>(fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>) => void, oListener?: Tcontext): this;
         ...
         * ** Note **: Currently the `sap.m.MultiComboBox` does not support this event.
        */
        attachLoadItems<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: sap.ui.base.Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachLoadItems(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireLoadItems(mParameters?: any): this;
