declare namespace jQuery.sap {
    ...
    */
    export class Version {
        ...
        */
        public constructor(vMajor: number | string | any[] | jQuery.sap.Version, iMinor: number, iPatch: number, sSuffix: string);
        ...
        */
        public inRange(vMin: string | any[] | jQuery.sap.Version, vMax: string | any[] | jQuery.sap.Version): boolean;
