declare namespace jquery.sap.global {
    ...
    */
    export class Logger {
        ...
        */
        public debug(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): jQuery.sap.log.Logger;

        /**
            * Creates a new error-level entry in the log with the given message, details and calling component.
        */
        public error(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): jQuery.sap.log.Logger;

        /**
            * Creates a new fatal-level entry in the log with the given message, details and calling component.
        */
        public fatal(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): jQuery.sap.log.Logger;
        ...
        */
        public info(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): jQuery.sap.log.Logger;
        ...
        */
        public trace(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): jQuery.sap.log.Logger;

        /**
            * Creates a new warning-level entry in the log with the given message, details and calling component.
        */
        public warning(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): jQuery.sap.log.Logger;
