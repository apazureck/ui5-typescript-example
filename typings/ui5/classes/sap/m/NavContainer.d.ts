declare module 'sap/m/NavContainer' {
    ...
    */
    export default class NavContainer extends Control {
        ...
        */
        attachAfterNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The page which had been shown before navigation. */
        ...
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The page which was shown before the current navigation. */
