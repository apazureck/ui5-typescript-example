declare module 'sap/m/SelectList' {
    ...
    export interface ISelectListSettings extends IControlSettings {
        ...
        keyboardNavigationMode?: SelectListKeyboardNavigationMode;
    }
    ...
    */
    export default class SelectList extends Control {
        ...
        */
        attachItemPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The pressed item. */
            item: Item,
        ...
        */
         ...
         * ** Note: ** The selection can be changed by pressing a non-selected item or via keyboard and after the enter or space key is pressed.
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected item. */
            selectedItem: Item,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
