declare module 'sap/m/FacetFilterList' {
    ...
    export interface IFacetFilterListSettings extends IListSettings {
        ...
        dataType?: FacetFilterListDataType;
    }
    ...
    */
    export default class FacetFilterList extends List {
        ...
        */
         ...
         * Triggered after the list of items is closed.
        */
        attachListClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Array of selected items. Items returned are only copies and therefore can only be used to read properties, not set them. */
            selectedItems: any[], /* * <code>True</code> if the select All checkbox is selected. This will be <code>false</code> if all items are actually selected (every FacetFilterItem.selected == true). In that case selectedItems will contain all selected items. */
            allSelected: boolean, /* * Associative array containing the keys of selected FacetFilterItems. Unlike the selectedItems parameter, this contains only the keys for all selected items, not the items themselves. Being an associative array, each object property is the FacetFilterItem key value and the value of the property is the FacetFilterItem text. */
            selectedKeys: any,
        ...
        */
        attachListOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
