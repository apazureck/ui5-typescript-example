    ...
    */
    export default class Slider extends Control {
        ...
        */
         ...
         * This event is triggered after the end user finishes interacting, if there is any change.
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The current value of the slider after a change. */
            value: number,
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The current value of the slider after a live change. */
            value: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
