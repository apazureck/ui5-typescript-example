declare module 'sap/m/RadioButtonGroup' {
    ...
    */
    export default class RadioButtonGroup extends Control {
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Index of the selected RadioButton. */
            selectedIndex: number,
