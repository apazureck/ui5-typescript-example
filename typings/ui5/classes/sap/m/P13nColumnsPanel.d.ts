    ...
    */
    export default class P13nColumnsPanel extends P13nPanel {
        ...
        */
         ...
         * Event raised when a `columnsItem` is added.
        */
        attachAddColumnsItem<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * <code>columnsItem</code> that needs to be added in the model. */
            newItem: P13nColumnsItem,
        ...
        */
        attachChangeColumnsItems<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Contains <code>columnsItems</code> that needs to be created in the model. Deprecated as of version 1.50, replaced by new parameter <code>items</code>. */
        ...
        */
        attachSetData<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
