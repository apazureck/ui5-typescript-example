    ...
    */
    export default class MenuItem extends Item {
        ...
        */
         ...
         * Fired when aggregation of the item changes.
        */
        attachAggregationChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The aggregation name of the changed aggregation. */
            aggregationName: string, /* * Which method changed the aggregation. */
            methodName: string, /* * What parameters were used to change the aggregation. */
            methodParams: any,
        ...
        */
        attachPropertyChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The property name to be changed. */
