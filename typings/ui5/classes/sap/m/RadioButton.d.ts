declare module 'sap/m/RadioButton' {
    ...
    */
    export default class RadioButton extends Control {
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Checks whether the RadioButton is active or not. */
            selected: boolean,
