    ...
    */
    export default class TextArea extends InputBase {
        ...
        */
         ...
         * Is fired whenever the user has modified the text shown on the text area.
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The new <code>value</code> of the control. */
            value: string,
        ...
        */
         ...
         * Default value is `None`.
        */
        public setWrapping(sWrapping: Wrapping): this;
