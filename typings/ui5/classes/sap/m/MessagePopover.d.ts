declare module 'sap/m/MessagePopover' {
    ...
    export interface IMessagePopoverSettings extends IControlSettings {
        ...
        asyncURLHandler?: any;
        placement?: VerticalPlacementType;
    ...
    */
    export default class MessagePopover extends Control {
        ...
        */
         ...
         * This event will be fired after the popover is closed
        */
        attachAfterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Refers to the control which opens the popover */
            openBy: Control,
        ...
        */
        attachAfterOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This refers to the control which opens the popover */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * This event will be fired before the popover is closed
        */
        attachBeforeClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Refers to the control which opens the popover See sap.ui.core.MessageType enum values for types */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBeforeOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Refers to the control which opens the popover */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * This event will be fired when description is shown
        */
        attachItemSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Refers to the message popover item that is being presented */
            item: MessagePopoverItem, /* * Refers to the type of messages being shown See sap.ui.core.MessageType values for types */
            messageTypeFilter: MessageType,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachListSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter refers to the type of messages being shown. */
            messageTypeFilter: MessageType,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * This event will be fired when the long text description data from a remote URL is loaded
        */
        attachLongtextLoaded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachUrlValidated<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        protected fireItemSelect(mParameters?: { item?: MessagePopoverItem, messageTypeFilter?: MessageType, }): this;

        /**
            * Fires event {@link #event:listSelect listSelect} to attached listeners.
        */
        protected fireListSelect(mParameters?: { messageTypeFilter?: MessageType, }): this;
