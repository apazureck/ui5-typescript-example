    ...
    */
    export default class Panel extends Control {
        ...
        */
         ...
         * Indicates that the panel will expand or collapse.
        */
        attachExpand<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * If the panel will expand, this is true. If the panel will collapse, this is false. */
            expand: boolean, /* * Identifies whether the event is triggered by an user interaction or by calling setExpanded. */
            triggeredByInteraction: boolean,
