    ...
    */
    export default class MultiComboBox extends ComboBoxBase {
        ...
        */
         ...
         * Event is fired when selection of an item is changed. Note: please do not use the "change" event inherited from sap.m.InputBase
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Item which selection is changed */
            changedItem: Item, /* * Selection state: true if item is selected, false if item is not selected */
            selected: boolean,
        ...
        */
         ...
         * Event is fired when user has finished a selection of items in a list box and list box has been closed.
        */
        attachSelectionFinish<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected items which are selected after list box has been closed. */
            selectedItems: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
