declare module 'sap/m/IconTabBar' {
    ...
    */
    export default class IconTabBar extends Control {
        ...
        */
        attachExpand<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * If the tab will expand, this is true. */
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected item */
