declare module 'sap/m/TableSelectDialog' {
    ...
    */
    export default class TableSelectDialog extends Control {
        ...
        */
        attachConfirm<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Returns the selected list item. When no item is selected, "null" is returned. When multi-selection is enabled and multiple items are selected, only the first selected item is returned. */
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Specifies the value entered in the search field. */
        ...
        */
         ...
         * Fires when the search button has been clicked on dialog.
        */
        attachSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Specifies the value entered in the search field. */
            value: string, /* * Determines the Items binding of the Table Select Dialog. Only available if the items aggregation is bound to a model. */
            itemsBinding: any,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
