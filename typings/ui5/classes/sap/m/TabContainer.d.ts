    ...
    */
    export default class TabContainer extends Control {
        ...
        */
         ...
         * Fired when the * Add New Tab * button is pressed.
        */
        attachAddNewButtonPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachItemClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item to be closed. */
        ...
        */
        attachItemSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected item. */
            item: TabContainerItem,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
