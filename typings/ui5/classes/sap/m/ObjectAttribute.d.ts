    ...
    */
    export default class ObjectAttribute extends Control {
        ...
        */
         ...
         * Fires when the user clicks on active text.
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * DOM reference of the ObjectAttribute's text to be used for positioning. */
            domRef: string,
