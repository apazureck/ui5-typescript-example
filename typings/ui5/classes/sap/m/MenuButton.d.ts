    ...
    */
    export default class MenuButton extends Control {
        ...
        */
         ...
         * Fired when the `buttonMode` is set to `Split` and the user presses the main button unless `useDefaultActionOnly` is set to `false` and another action from the menu has been selected previously.
        */
        attachDefaultAction<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
