declare module 'sap/m/Carousel' {
    ...
    export interface ICarouselSettings extends IControlSettings {
        ...
        pageIndicatorPlacement?: PlacementType;
    ...
    */
    export default class Carousel extends Control {
        ...
        */
         ...
         * Carousel requires a new page to be loaded. This event may be used to fill the content of that page
        */
        attachLoadPage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the page which will be loaded */
            pageId: string,
        ...
        */
        attachPageChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the page which was active before the page change. */
        ...
        */
        attachUnloadPage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the page which will be unloaded */
            pageId: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
