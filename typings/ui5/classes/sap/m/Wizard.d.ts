declare module 'sap/m/Wizard' {
    ...
    */
    export default class Wizard extends Control {
        ...
        */
         ...
         * The complete event is fired when the user clicks the finish button of the Wizard. The finish button is only available on the last step of the Wizard.
        */
        attachComplete<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachStepActivate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The index of the activated step as a parameter. One-based. */
            index: number,
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachStepActivate(fnFunction: Function, oListener: any): this;
