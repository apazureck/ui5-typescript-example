    ...
    */
    export default class TileContainer extends Control {
        ...
        */
         ...
         * Fires when a Tile is added.
        */
        attachTileAdd<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachTileDelete<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The deleted Tile. */
            tile: Tile,
        ...
        */
        attachTileMove<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The Tile that has been moved. */
