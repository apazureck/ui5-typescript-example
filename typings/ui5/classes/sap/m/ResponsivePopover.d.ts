    ...
    */
    export default class ResponsivePopover extends Control {
        ...
        */
         ...
         * Event is fired after popover or dialog is closed.
        */
        attachAfterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter contains the control which is passed as the parameter when calling openBy method. When runs on the phone, this parameter is undefined. */
            openBy: Control, /* * This parameter contains the control which triggers the close of the ResponsivePopover. This parameter is undefined when runs on desktop or tablet. */
            origin: Button,
        ...
        */
        attachAfterOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter contains the control which is passed as the parameter when calling openBy method. When runs on the phone, this parameter is undefined. */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired before popover or dialog is closed.
        */
        attachBeforeClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter contains the control which is passed as the parameter when calling openBy method. When runs on the phone, this parameter is undefined. */
            openBy: Control, /* * This parameter contains the control which triggers the close of the ResponsivePopover. This parameter is undefined when runs on desktop or tablet. */
            origin: Button,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired before popover or dialog is open.
        */
        attachBeforeOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter contains the control which is passed as the parameter when calling openBy method. When runs on the phone, this parameter is undefined. */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
