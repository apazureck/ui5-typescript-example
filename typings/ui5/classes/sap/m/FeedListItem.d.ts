declare module 'sap/m/FeedListItem' {
    ...
    export interface IFeedListItemSettings extends IListItemBaseSettings {
        ...
        showIcon?: boolean;
        convertLinksToAnchorTags?: LinkConversion;
    ...
    */
    export default class FeedListItem extends ListItemBase {
        ...
        */
         ...
         * Event is fired when the icon is pressed.
        */
        attachIconPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Dom reference of the feed item's icon to be used for positioning. */
            domRef: string, /* * Function to retrieve the DOM reference for the <code>iconPress</code> event. The function returns the DOM element of the icon or null */
            getDomRef: Function,
        ...
        */
        attachSenderPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Dom reference of the feed item's sender string to be used for positioning. */
