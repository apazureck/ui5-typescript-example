    ...
    */
    export default class DatePicker extends DateTimeField {
        ...
        */
         ...
         * Fired when navigating in `Calendar` popup.
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Date range containing the start and end date displayed in the <code>Calendar</code> popup. */
            dateRange: DateRange,
