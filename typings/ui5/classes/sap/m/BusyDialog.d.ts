    ...
    */
    export default class BusyDialog extends Control {
        ...
        */
         ...
         * Fires when the busy dialog is closed.
        */
        attachClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Indicates if the close events are triggered by a user, pressing a cancel button or because the operation was terminated. This parameter is set to true if the close event is fired by user interaction. */
            cancelPressed: boolean,
