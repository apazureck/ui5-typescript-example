    ...
    */
    export default class MultiInput extends Input {
        ...
        */
         ...
         * Fired when the tokens aggregation changed (add / remove token)
        */
        attachTokenUpdate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Type of tokenChange event. There are two TokenUpdate types: "added", "removed" Use Tokenizer.TokenUpdateType.Added for "added" and Tokenizer.TokenUpdateType.Removed for "removed". */
            type: string, /* * The array of tokens that are added. This parameter is used when tokenUpdate type is "added". */
            addedTokens: any[], /* * The array of tokens that are removed. This parameter is used when tokenUpdate type is "removed". */
            removedTokens: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
