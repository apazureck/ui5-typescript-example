declare module 'sap/m/ListBase' {
    ...
    export interface IListBaseSettings extends IControlSettings {
        ...
        growingDirection?: ListGrowingDirection;
        rememberSelections?: boolean;
        keyboardMode?: ListKeyboardMode;
    }
    ...
    */
    export default class ListBase extends Control {
        ...
        */
        attachDelete<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item which fired the delete event. */
        ...
        */
         ...
         * Fires after the new growing chunk has been fetched from the model and processed by the control.
        */
        attachGrowingFinished<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Actual number of items. */
            actual: number, /* * Total number of items. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Fires before the new growing chunk is requested from the model.
        */
        attachGrowingStarted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Actual number of items. */
            actual: number, /* * Total number of items. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachItemPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item which fired the pressed event. */
        ...
        */
         ...
         * Fires when selection is changed via user interaction. In `MultiSelect` mode, this event is also fired on deselection.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item which fired the select event. */
            listItem: ListItemBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item whose selection has changed. In <code>MultiSelect</code> mode, only the up-most selected item is returned. This parameter can be used for single-selection modes. */
        ...
        */
         ...
         * Fires after user's swipe action and before the `swipeContent` is shown. On the `swipe` event handler, `swipeContent` can be changed according to the swiped item. Calling the `preventDefault` method of the event cancels the swipe action.
        */
        attachSwipe<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item which fired the swipe. */
            listItem: ListItemBase, /* * Aggregated <code>swipeContent</code> control that is shown on the right hand side of the item. */
            swipeContent: Control, /* * Holds which control caused the swipe event within the item. */
            srcControl: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Fires after `items` binding is updated and processed by the control.
        */
        attachUpdateFinished<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The reason of the update, e.g. Binding, Filter, Sort, Growing, Change, Refresh, Context. */
            reason: string, /* * Actual number of items. */
            actual: number, /* * The total count of bound items. This can be used if the <code>growing</code> property is set to <code>true</code>. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * ** Note: ** Event handler should not invalidate the control.
        */
        attachUpdateStarted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The reason of the update, e.g. Binding, Filter, Sort, Growing, Change, Refresh, Context. */
            reason: string, /* * Actual number of items. */
            actual: number, /* * The total count of bound items. This can be used if the <code>growing</code> property is set to <code>true</code>. */
            total: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
