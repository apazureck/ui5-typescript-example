declare module 'sap/m/TabContainerItem' {
    ...
    */
    export default class TabContainerItem extends Element {
        ...
        */
        attachItemPropertyChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The item changed. */
