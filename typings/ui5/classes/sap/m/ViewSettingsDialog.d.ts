declare module 'sap/m/ViewSettingsDialog' {
    ...
    export interface IViewSettingsDialogSettings extends IControlSettings {
        ...
        filterSearchOperator?: StringFilterOperator;
    }
    ...
    */
    export default class ViewSettingsDialog extends Control {
        ...
        */
        attachConfirm<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected sort item. */
        ...
        */
         ...
         * Fired when the filter detail page is opened.
        */
        attachFilterDetailPageOpened<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The filter item for which the details are opened. */
            parentFilterItem: ViewSettingsFilterItem,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Called when the reset filters button is pressed. It can be used to clear the state of custom filter controls.
        */
        attachResetFilters<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
