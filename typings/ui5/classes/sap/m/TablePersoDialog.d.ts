    ...
    */
    export default class TablePersoDialog extends ManagedObject {
        ...
        */
         ...
         * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified, otherwise it will be bound to this `sap.m.TablePersoDialog` itself.
        */
        attachConfirm<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public setColumnInfoCallback(oColumnInfoCallback: any): this;
        ...
        */
         ...
         * When called with a value of `null` or `undefined`, the default value of the property will be restored.
        */
        public setInitialColumnState(oInitialColumnState: any): this;
        ...
        */
         ...
         * When called with a value of `null` or `undefined`, the default value of the property will be restored.
        */
        public setPersoMap(oPersoMap: any): this;
