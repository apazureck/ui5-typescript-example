    ...
    */
    export default class QuickView extends QuickViewBase {
        ...
        */
         ...
         * This event fires after the QuickView is closed.
        */
        attachAfterClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter refers to the control, which opens the QuickView. */
            openBy: Control, /* * This parameter contains the control, which triggers the close of the QuickView. It is undefined when running on desktop or tablet. */
            origin: Button,
        ...
        */
        attachAfterOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter refers to the control, which opens the QuickView. */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBeforeClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter refers to the control, which opens the QuickView. */
            openBy: Control, /* * This parameter contains the control, which triggers the close of the QuickView. It is undefined when running on desktop or tablet. */
            origin: Button,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachBeforeOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * This parameter refers to the control, which opens the QuickView. */
            openBy: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
