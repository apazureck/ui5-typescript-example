declare module 'sap/m/PlanningCalendar' {
    ...
    export interface IPlanningCalendarSettings extends IControlSettings {
        ...
        noDataText?: string;
        groupAppointmentsMode?: GroupAppointmentsMode;
        appointmentsReducedHeight?: boolean;
        appointmentsVisualization?: CalendarAppointmentVisualization;
        minDate?: any;
        maxDate?: any;
    ...
    */
    export default class PlanningCalendar extends Control {
        ...
        */
         ...
         * Fired if an appointment is selected.
        */
        attachAppointmentSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected appointment. */
            appointment: CalendarAppointment, /* * The selected appointments in case a group appointment is selected. */
            appointments: any[], /* * If set, the appointment was selected using multiple selection (e.g. Shift + single mouse click), meaning more than the current appointment could be selected. */
            multiSelect: boolean, /* * Gives the ID of the DOM element of the clicked appointment */
            domRefId: string,
        ...
        */
         ...
         * Fired if an interval was selected in the calendar header or in the row.
        */
        attachIntervalSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Start date of the selected interval, as a JavaScript date object. */
            startDate: any, /* * Interval end date as a JavaScript date object. */
            endDate: any, /* * If set, the selected interval is a subinterval. */
            subInterval: boolean, /* * Row of the selected interval. */
            row: PlanningCalendarRow,
        ...
        */
         ...
         * Fires when a row header is clicked.
        */
        attachRowHeaderClick<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Fires when row selection is changed.
        */
        attachRowSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Array of rows whose selection has changed. */
            rows: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * `startDate` was changed while navigating in the `PlanningCalendar`. The new value can be obtained using the `sap.m.PlanningCalendar#getStartDate()` method.
        */
        attachStartDateChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachViewChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
