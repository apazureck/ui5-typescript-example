declare module 'sap/m/SegmentedButton' {
    ...
    */
    export default class SegmentedButton extends Control {
        ...
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Reference to the button, that has been selected. */
        ...
        */
         ...
         * Fires when the user selects an item, which returns the item object.
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Reference to the item, that has been selected. */
            item: SegmentedButtonItem,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public createButton(sText: string, sURI: sap.ui.core.URI, bEnabled: boolean, sTextDirection?: TextDirection): Button;
