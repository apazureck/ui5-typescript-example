declare module 'sap/uxap/ObjectPageLayout' {
    ...
    export interface IObjectPageLayoutSettings extends IControlSettings {
        ...
        subSectionLayout?: ObjectPageSubSectionLayout;
        sectionTitleLevel?: TitleLevel;
    ...
    */
    export default class ObjectPageLayout extends Control {
        ...
        */
         ...
         * The event is fired when the Edit Header button is pressed
        */
        attachEditHeaderButtonPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * The event is fired when the selected section is changed using the navigation.
        */
        attachNavigate<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The selected section object. */
            section: ObjectPageSection,
        ...
        */
         ...
         * The event is fired when the Anchor bar is switched from moving to fixed or the other way round.
        */
        attachToggleAnchorBar<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * False indicates that the Anchor bar has just detached from the Header and became part of the scrolling area. True means that the Anchor bar has just snapped to the Header. */
            fixed: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public getSectionTitleLevel(): TitleLevel;
        ...
        */
         ...
         * Default value is `Auto`.
        */
        public setSectionTitleLevel(sSectionTitleLevel: TitleLevel): this;
