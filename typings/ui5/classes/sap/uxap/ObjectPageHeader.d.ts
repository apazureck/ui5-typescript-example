declare module 'sap/uxap/ObjectPageHeader' {
    ...
    export interface IObjectPageHeaderSettings extends IControlSettings {
        ...
        objectImageShape?: ObjectPageHeaderPictureShape;
        ...
        headerDesign?: ObjectPageHeaderDesign;
    ...
    */
    export default class ObjectPageHeader extends Control {
        ...
        */
        attachMarkChangesPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * DOM reference of the changed item's icon to be used for positioning. */
            domRef: string,
        ...
        */
         ...
         * The event is fired when the Locked button is pressed
        */
        attachMarkLockedPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * DOM reference of the lock item's icon to be used for positioning. */
            domRef: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachTitleSelectorPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * DOM reference of the title item's icon to be used for positioning. */
            domRef: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
