declare module 'sap/ui/model/odata/type/Decimal' {
    ...
    */
    export default class Decimal extends ODataType {
        ...
        */
        public constructor(oFormatOptions?: any, oConstraints?: { maximum?: string, maximumExclusive?: boolean, minimum?: string, minimumExclusive?: boolean, nullable?: boolean | string, precision?: number | string, scale?: number | string, });
