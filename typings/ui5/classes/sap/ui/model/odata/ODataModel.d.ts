declare module 'sap/ui/model/odata/ODataModel' {
    ...
    */
    export default class ODataModel extends Model {
        ...
        */
        public addBatchChangeOperations(aChangeOperations: any[]): any;
        ...
        */
        public addBatchReadOperations(aReadOperations: any[]): any;

        /**
            * Attach event-handler `fnFunction` to the 'annotationsFailed' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachAnnotationsFailed(oData: any, fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'annotationsFailed' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachAnnotationsFailed(fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'annotationsLoaded' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachAnnotationsLoaded(fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'annotationsLoaded' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachAnnotationsLoaded(oData: any, fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'metadataFailed' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachMetadataFailed(oData: any, fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'metadataFailed' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachMetadataFailed(fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'metadataLoaded' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachMetadataLoaded(fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'metadataLoaded' event of this `sap.ui.model.odata.ODataModel`.
        */
        public attachMetadataLoaded(oData: any, fnFunction: Function, oListener?: any): this;
        ...
        */
        public bindList(sPath: string, oContext?: Context, aSorters?: Sorter | any[], aFilters?: Filter | any[], mParameters?: { expand?: string, select?: string, custom?: any, countMode?: CountMode, }): ListBinding;

        /**
            * Trigger a request to the function import odata service that was specified in the model constructor.
        */
        public callFunction(sFunctionName: string, mParameters?: { method?: string, urlParameters?: any, context?: any, success?: Function, error?: Function, async?: boolean, }): any;
        ...
        */
        public create(sPath: string, oData: any, mParameters?: { context?: any, success?: Function, error?: Function, async?: boolean, urlParameters?: any, }): any;

        /**
            * Creates a single batch operation (read or change operation) which can be used in a batch request.
        */
        public createBatchOperation(sPath: string, sMethod: string, oData?: any, oParameters?: { sETag?: string, }): any;
        ...
        */
        public createEntry(sPath: string, vProperties: any[] | any): Context;

        /**
            * Creates the key from the given collection name and property map
        */
        public createKey(sCollection: string, oKeyParameters: any, bDecode: boolean): any;
        ...
        */
        public getKey(oObject: any | Context, bDecode: boolean): any;
        ...
        */
        public read(sPath: string, mParameters?: { context?: any, urlParameters?: any, async?: boolean, filters?: any[], sorters?: any[], success?: Function, error?: Function, }): any;
        ...
        */
        public remove(sPath: string, mParameters?: { context?: any, success?: Function, error?: Function, eTag?: string, payload?: any, async?: boolean, urlParameters?: any, }): any;

        /**
            * Resets the collected changes by the setProperty method and reloads the data from the server.
        */
        public resetChanges(fnSuccess?: Function, fnError?: Function): any;
        ...
        */
        public submitChanges(fnSuccess?: Function, fnError?: Function, oParameters?: { sETag?: string, }): any;
        ...
        */
        public update(sPath: string, oData: any, mParameters?: { context?: any, success?: Function, error?: Function, merge?: boolean, eTag?: string, async?: boolean, urlParameters?: any, }): any;
