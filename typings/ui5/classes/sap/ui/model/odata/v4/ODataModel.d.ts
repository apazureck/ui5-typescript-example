declare module 'sap/ui/model/odata/v4/ODataModel' {
    ...
    */
    export default class ODataModel extends Model {
        ...
        */
        public bindList(sPath: string, oContext?: sap_ui_model_Context, vSorters?: Sorter | any[], vFilters?: Filter | any[], mParameters?: { operationMode?: OperationMode, $$groupId?: string, $$updateGroupId?: string, }): ODataListBinding | ListBinding;
