declare module 'sap/ui/model/odata/ODataListBinding' {
    ...
    */
    export default class ODataListBinding extends ListBinding {
        ...
        */
        public constructor(oModel: ODataModel, sPath: string, oContext: Context, aSorters?: any[], aFilters?: any[], mParameters?: { expand?: string, select?: string, custom?: any, countMode?: CountMode, });
        ...
        */
        public filter(aFilters: any[] | any[], sFilterType: FilterType): this;
