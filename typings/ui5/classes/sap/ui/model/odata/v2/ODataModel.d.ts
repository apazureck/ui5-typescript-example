    ...
    export default class ODataModel extends Model {
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the `annotationsFailed` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachAnnotationsFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * An array of Errors */
            result: any[],
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the `annotationsLoaded` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachAnnotationsLoaded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * An array consisting of one or several annotation sources and/or errors containing a source property and error details. */
            result: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the `batchRequestCompleted` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachBatchRequestCompleted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The request ID */
            ID: string, /* * The URL which is sent to the backend */
            url: string, /* * The HTTP method */
            method: string, /* * The request headers */
            headers: any, /* * Request was successful or not */
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the `batchRequestFailed` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachBatchRequestFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The request ID */
            ID: string, /* * The URL which is sent to the backend */
            url: string, /* * The HTTP method */
            method: string, /* * The request headers */
            headers: any, /* * If the request is synchronous or asynchronous (if available) */
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the `requestSent` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachBatchRequestSent<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The URL which is sent to the backend */
            url: string, /* * The type of the request (if available) */
            type?: string, /* * If the request is synchronous or asynchronous (if available) */
            async?: boolean, /* * Array of embedded requests ($batch) Each request object within the array contains the following properties: url, method, headers */
            requests: any[],
        ...
        */
        attachMetadataFailed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The parsed metadata */
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the `metadataLoaded` event of this `sap.ui.model.odata.v2.ODataModel`.
        */
        attachMetadataLoaded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The parsed metadata */
            metadata: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public bindList(sPath: string, oContext?: Context, aSorters?: Sorter | any[], aFilters?: Filter | any[], mParameters?: { expand?: string, select?: string, custom?: any, countMode?: CountMode, operationMode?: OperationMode, faultTolerant?: boolean, batchGroupId?: string, threshold?: number, }): ListBinding;
        ...
        */
        public bindTree(sPath: string, oContext?: Context, aFilters?: Filter | any[], mParameters?: { treeAnnotationProperties?: any, navigation?: any, numberOfExpandedLevels?: number, rootLevel?: number, batchGroupId?: string, groupId?: string, operationMode?: OperationMode, threshold?: number, useServersideApplicationFilters?: boolean, treeState?: boolean, }, aSorters?: any[]): TreeBinding;
        ...
        */
        public createBindingContext(sPath: string, oContext?: any, mParameters?: { expand?: string, select?: string, preliminaryContext?: boolean, custom?: any, }, fnCallBack?: Function, bReload?: boolean): Context;
        ...
        */
        public createEntry(sPath: string, mParameters: { properties?: any[] | any, batchGroupId?: string, groupId?: string, changeSetId?: string, context?: Context, success?: Function, error?: Function, headers?: any, urlParameters?: any, refreshAfterChange?: string, }): Context;
        ...
        */
        public getETag(sPath?: string, oContext?: Context, oEntity?: any): string;
        ...
        */
        public getKey(vValue: string | any | Context): string;
