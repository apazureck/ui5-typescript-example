declare module 'sap/ui/model/odata/v2/ODataListBinding' {
    ...
    */
    export default class ODataListBinding extends ListBinding {
        ...
        */
        public constructor(oModel: ODataModel, sPath: string, oContext: Context, aSorters?: Sorter | any[], aFilters?: Filter | any[], mParameters?: { expand?: string, select?: string, custom?: any, countMode?: CountMode, operationMode?: OperationMode, faultTolerant?: boolean, batchGroupId?: string, threshold?: number, });
        ...
        */
        public filter(aFilters: Filter | any[], sFilterType: FilterType, bReturnSuccess?: boolean): this;
        ...
        */
        ...
        /**
            * Sorts the list.
        */
        public sort(aSorters: Sorter | any[], bReturnSuccess?: boolean): this;
