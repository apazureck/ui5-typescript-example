    ...
    export default class Month extends Control {
        ...
        */
        attachFocus<Tcontext>(fnFunction: (this: Tcontext, oEvent: Event<this, { /* * focused date */
            date: any, /* * focused date is in an other month that the displayed one */
         ...
         * Date focus changed
        */
        attachFocus<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * focused date */
            date: any, /* * focused date is in an other month that the displayed one */
            otherMonth: boolean, /* * focused date is set to the same as before (date in other month clicked) */
            restoreOldDate: boolean,
        ...
        */
        public detachFocus(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireFocus(mParameters?: { date?: any, otherMonth?: boolean, restoreOldDate?: boolean, }): this;
