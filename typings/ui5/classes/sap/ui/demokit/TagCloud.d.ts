declare module 'sap/ui/demokit/TagCloud' {
    ...
    */
    export default class TagCloud extends Control {
        ...
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the selected Tag. */
            tagId: string,
