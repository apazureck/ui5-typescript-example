declare module 'sap/ui/demokit/CodeSampleContainer' {
    ...
    */
    export default class CodeSampleContainer extends Control {
        ...
        */
         ...
         * Fired when the user decides to apply his/her changes to the sample code
        */
        attachApply<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * the current code that will be applied */
            code: string,
