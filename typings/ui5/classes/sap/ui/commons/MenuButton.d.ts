declare module 'sap/ui/commons/MenuButton' {
    ...
    import * as MenuItemBaseImport from "sap/ui/commons/MenuItemBase";
    type sap_ui_commons_MenuItemBase = MenuItemBaseImport.default;
    ...
    */
    export default class MenuButton extends Button {
        ...
        */
         ...
         * Event that is fired when a menu item is selected by the user
        */
        attachItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the selected item */
            itemId: string, /* * The selected item */
            item: MenuItemBase,
        ...
        */
         ...
         * Event is fired when an item from the menu was selected.
        */
        attachPress<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The id of the selected item */
            itemId: string, /* * The selected item */
            item: sap_ui_commons_MenuItemBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
