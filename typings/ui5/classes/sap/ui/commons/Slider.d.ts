declare module 'sap/ui/commons/Slider' {
    ...
    */
    export default class Slider extends Control {
        ...
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current value of the slider after a change. */
            value: number,
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current value of the slider after a change. */
            value: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
