declare module 'sap/ui/commons/ListBox' {
    ...
    export interface IListBoxSettings extends IControlSettings {
        ...
        secondaryValueTextAlign?: TextAlign;
    ...
    */
    export default class ListBox extends Control {
        ...
        */
        public addSelectedIndices(aSelectedIndices: any[]): this;
        ...
        */
         ...
         * Event is fired when selection is changed by user interaction.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * ID of the ListBox which triggered the event. */
            id: string, /* * The currently selected index of the ListBox. In the case of multiple selection, this is exactly one of the selected indices - the one whose selection has triggered the selection change. To get all currently selected indices, use selectedIndices. */
            selectedIndex: number, /* * The currently selected item of the ListBox. In the case of multiple selection, this is exactly one of the selected items - the one whose selection has triggered the selection change. */
            selectedItem: Item, /* * Array containing the indices which are selected. */
            selectedIndices: any[],
        ...
        */
        protected fireSelect(mParameters?: { id?: string, selectedIndex?: number, selectedItem?: Item, selectedIndices?: any[], }): this;
        ...
        */
        public getSecondaryValueTextAlign(): TextAlign;
        ...
        */
         ...
         * Default value is `Begin`.
        */
        public getValueTextAlign(): TextAlign;
        ...
        */
        public setItems(aItems: any[], bDestroyItems: boolean): this;
        ...
        */
         ...
         * Default value is `Begin`.
        */
        public setSecondaryValueTextAlign(sSecondaryValueTextAlign: TextAlign): this;
        ...
        */
        public setSelectedIndices(aSelectedIndices: any[]): this;
        ...
        */
        public setSelectedKeys(aSelectedKeys: any[]): this;
         ...
         * Default value is `Begin`.
        */
        public setValueTextAlign(sValueTextAlign: TextAlign): this;
