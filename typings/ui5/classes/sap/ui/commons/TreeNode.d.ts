declare module 'sap/ui/commons/TreeNode' {
    ...
    */
    export default class TreeNode extends Element {
        ...
        */
         ...
         * Node is selected
        */
        attachSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Node state has changed.
        */
        attachToggleOpenState<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Node has been opened if true */
            opened: boolean,
