    ...
    */
    export default class RowRepeater extends Control {
        ...
        */
         ...
         * This event is triggered when a filter is set.
        */
        attachFilter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the filter that has just been applied. */
            filterId: string,
        ...
        */
        attachPage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The value of the currentPage property after the change. */
        ...
        */
         ...
         * This event is triggered when the number of rows was changed.
        */
        attachResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The value of the numberOfRows property after the change. */
            numberOfRows: number, /* * The value of the numberOfRows property before the change. */
            previousNumberOfRows: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * This event is triggered when a sorting is applied.
        */
        attachSort<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the sorter that has just been applied. */
            sorterId: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
