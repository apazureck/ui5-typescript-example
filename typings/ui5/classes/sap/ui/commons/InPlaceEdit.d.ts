    ...
    */
    export default class InPlaceEdit extends Control {
        ...
        */
         ...
         * Event is fired when the text in the field has changed AND the focus leaves the InPlaceEdit or the Enter key is pressed.
        */
        attachChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The new / changed value of the InPlaceEdit. */
            newValue: string,
        ...
        */
        attachLiveChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current value of the Textfield. */
            liveValue: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
