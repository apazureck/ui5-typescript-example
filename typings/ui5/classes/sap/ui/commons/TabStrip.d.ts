declare module 'sap/ui/commons/TabStrip' {
    ...
    */
    export default class TabStrip extends Control {
        ...
        */
        attachClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The index of the closed tab. */
            index: number,
        ...
        */
         ...
         * Fires when the user selects a tab.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The index of the selected tab. */
            index: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
