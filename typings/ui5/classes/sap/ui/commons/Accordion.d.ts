    ...
    */
    export default class Accordion extends Control {
        ...
        */
         ...
         * Event is triggered when the user closes a section.
        */
        attachSectionClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * ID of the closed section */
            closeSectionId: string,
        ...
        */
        attachSectionOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * ID of the opened section */
        ...
        */
        attachSectionsReorder<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * ID of the moved section */
