declare module 'sap/ui/commons/layout/BorderLayout' {
    ...
    */
    export default class BorderLayout extends Control {
        ...
        */
        public createArea(sAreaId: BorderLayoutAreaTypes, oContent: Control): BorderLayoutArea;
        ...
        */
        public indexOfContent(sAreaId: BorderLayoutAreaTypes, oContent: Control): number;
