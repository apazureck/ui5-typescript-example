    ...
    */
    export default class Tree extends Control {
        ...
        */
         ...
         * Event is fired when a tree node is selected.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The node which has been selected. */
            node: TreeNode, /* * The binding context of the selected node. */
            nodeContext: any,
        ...
        */
        attachSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The nodes which has been selected. */
