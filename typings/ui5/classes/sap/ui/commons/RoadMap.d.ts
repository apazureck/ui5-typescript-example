    ...
    */
    export default class RoadMap extends Control {
        ...
        */
         ...
         * Event is fired when a given step is expanded or collapsed by user.
        */
        attachStepExpanded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * ID of the expanded/collapsed step */
            stepId: string,
        ...
        */
        attachStepSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * ID of the selected step */
            stepId: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
