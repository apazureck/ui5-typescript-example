    ...
    */
    export default class CalloutBase extends TooltipBase {
        ...
        */
         ...
         * Event is fired before a Callout is displayed. Call the preventDefault method of the event object to postpone opening. Application may use this event to start asynchronous Ajax call to load the Callout content
        */
        attachBeforeOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Parent control that has this Callout as a tooltip */
            parent: Control,
        ...
        */
         ...
         * The event is fired when the popup is opened.
        */
        attachOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Parent control that has this Callout as a tooltip */
            parent: Control,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
