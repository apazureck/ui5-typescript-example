declare module 'sap/ui/commons/Dialog' {
    ...
    export interface IDialogSettings extends IControlSettings {
        ...
        contentBorderDesign?: BorderDesign;
        modal?: boolean;
    ...
    */
    export default class Dialog extends Control {
        ...
        */
        attachClosed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The width of the dialog when closed */
