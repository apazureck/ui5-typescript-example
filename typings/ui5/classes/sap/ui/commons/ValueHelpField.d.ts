    ...
    */
    export default class ValueHelpField extends TextField {
        ...
        */
         ...
         * Event which is fired when the ValueHelp is requested.
        */
        attachValueHelpRequest<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
