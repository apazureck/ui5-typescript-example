declare module 'sap/ui/commons/MenuTextFieldItem' {
    ...
    import * as base from 'sap/ui/unified/MenuTextFieldItem'

    export interface IMenuTextFieldItemSettings extends base.IMenuTextFieldItemSettings {
    }

    /**
    
    */
    export default class MenuTextFieldItem extends
        base.default {
