declare module 'sap/ui/test/Opa5' {
    ...
    */
    export default class Opa5 extends Object {
        ...
        */
         ...
         *     ``
        */
        public static extendConfig(options: any): any;
        ...
        */
        public iStartMyUIComponent(oOptions: { componentConfig: any, hash?: string, timeout?: number, }): any;
