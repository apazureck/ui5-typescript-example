    ...
    */
    export default class OpaPlugin {
        ...
        */
         ...
         * 
        */
        public getControlInView(oOptions: any): Element | any[] | any;

        /**
            * Tries to find a control depending on the options provided.
        */
        public getMatchingControls(oOptions?: { viewName?: string, id?: string | any[], visible?: boolean, interactable?: boolean, searchOpenDialogs?: boolean, controlType?: string | Function, }): Element | any[] | any;
