    ...
    */
    export default class Splitter extends Control {
        ...
        */
         ...
         * Event is fired when contents are resized.
        */
        attachResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the splitter control. The splitter control can also be accessed by calling getSource() on the event. */
            id: string, /* * An array of values representing the old (pixel-)sizes of the splitter contents */
            oldSizes: any[], /* * An array of values representing the new (pixel-)sizes of the splitter contents */
            newSizes: any[],
        ...
        */
         ...
         * Default value is `Horizontal`.
        */
        public setOrientation(sOrientation: Orientation): this;
