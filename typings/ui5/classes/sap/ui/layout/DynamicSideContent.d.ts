declare module 'sap/ui/layout/DynamicSideContent' {
    ...
    */
    export default class DynamicSideContent extends Control {
        ...
        */
        attachBreakpointChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { currentBreakpoint: string, }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
