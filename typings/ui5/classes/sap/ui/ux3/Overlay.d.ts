    ...
    */
    export default class Overlay extends Control {
        ...
        */
         ...
         * Event is fired when the Overlay starts closing.
        */
        attachClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the Overlay instance. */
            id: string,
        ...
        */
        attachClosed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the Overlay instance. */
            id: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the Overlay instance */
            id: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when the 'Open' button of the Overlay is clicked.
        */
        attachOpenNew<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the Overlay instance. */
            id: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
