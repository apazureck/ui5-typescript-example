declare module 'sap/ui/ux3/Shell' {
    ...
    export interface IShellSettings extends IControlSettings {
        ...
        showTools?: boolean;
        showPane?: boolean;
        headerType?: ShellHeaderType;
        designType?: ShellDesignType;
        paneWidth?: number;
    ...
    */
    export default class Shell extends Control {
        ...
        */
        attachFeedSubmit<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachLogout<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachPaneBarItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The ID of the selected PaneBarItem. */
        ...
        */
         ...
         * Fired after a side pane of the shell is closed. It is also fired, when an open pane is closed by calling setShowPane(false), if and only if the pane was opened before.
        */
        attachPaneClosed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The id of the PaneBarItem to which the closed pane belonged. */
            id: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Fired when search has been triggered.
        */
        attachSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Fired when a workset item was selected by the user. The application may populate the sub-items of the given workset item in the event handler, but this must happen synchronously. If this is done, the application is responsible for displaying the correct content for the selected one of the newly created sub-items. The Shell will currently always mark the first sub-item as selected.
        */
        attachWorksetItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The id of the workset item that has been newly selected by the user. If a top-level item has been clicked which has sub-items, the ID of the currently active sub-item (/leaf) is given. */
            id: string, /* * The selected NavigationItem */
            item: NavigationItem, /* * The key of the selected NavigationItem (or null if there is no key) */
            key: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public setContent(oContent: Control, bDestroyOldContent: boolean): any[];
        ...
        */
        public setPaneContent(oContent: Control, bDestroyOldContent: boolean): any[];
