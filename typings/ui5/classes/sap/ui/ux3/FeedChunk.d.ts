declare module 'sap/ui/ux3/FeedChunk' {
    ...
    */
    export default class FeedChunk extends Control {
        ...
        */
        attachActionItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The Id of the selected item */
        ...
        */
         ...
         * Event is raised when a comment is added to the entry. This event is not supported for comment chunks.
        */
        attachCommentAdded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * New comment chunk */
            comment: FeedChunk,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachDeleted<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when the inspect button was pressed
        */
        attachInspect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Click on a @-reference
        */
        attachReferenceClicked<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Text of the @-reference */
            text: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when the thumbnail or the name of the sender is clicked.
        */
        attachSenderClicked<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is raised when the user clicks to set the entry as favorite. This event is not supported for comment chunks.
        */
        attachToggleFavorite<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current favorite state */
            favorite: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachToggleFlagged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current flagged state */
            flagged: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is raised when the user clicks to share the entry. This event is not supported for comment chunks.
        */
        attachToggleShared<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current shared state */
            shareed: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
