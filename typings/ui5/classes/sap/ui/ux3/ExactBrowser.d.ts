    ...
    */
    export default class ExactBrowser extends Control {
        ...
        */
         ...
         * Event is fired when an attribute is selected or unselected.
        */
        attachAttributeSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The attribute which was selected or unselected recently */
            attribute: ExactAttribute, /* * Array of all selected ExactAttributes */
            allAttributes: any,
         ...
         * Event is fired when an attribute is selected or unselected.
        */
        attachSave<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
