    ...
    */
    export default class Feed extends Control {
        ...
        */
         ...
         * Event is fired when a new chunk is added
        */
        attachChunkAdded<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * New chunk */
            chunk: FeedChunk,
        ...
        */
         ...
         * Event is fired when the filter is changed
        */
        attachFilterChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The new/changed value of the filter */
            newValue: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when the search function on SearchField is triggered
        */
        attachSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The search query */
            query: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when the live mode has changed
        */
        attachToggleLive<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Current live indicator */
            live: boolean,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when an item from the tools MenuButton was selected
        */
        attachToolsItemSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The Id of the selected item */
            itemId: string, /* * The selected item */
            item: MenuItemBase,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
