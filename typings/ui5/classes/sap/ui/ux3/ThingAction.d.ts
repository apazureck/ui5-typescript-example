declare module 'sap/ui/ux3/ThingAction' {
    ...
    */
    export default class ThingAction extends Element {
        ...
        */
         ...
         * Event will be fired when the action was triggered.
        */
        attachSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of selected action */
            id: string, /* * Selected Thing Action */
            action: ThingAction,
