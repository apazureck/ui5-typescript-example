declare module 'sap/ui/ux3/ThingInspector' {
    ...
    export interface IThingInspectorSettings extends IOverlaySettings {
        ...
        headerType?: ThingViewerHeaderType;
    }
    ...
    */
    export default class ThingInspector extends Overlay {
        ...
        */
         ...
         * Further thing related Action selected
        */
        attachActionSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of selected ThingAction */
            id: string, /* * Selected ThingAction */
            action: ThingAction,
        ...
        */
        attachFacetSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of selected NavigationItem */
        ...
        */
         ...
         * Fired when a new feed entry is submitted.
        */
        attachFeedSubmit<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Feed text */
            text: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachFacetSelected(fnFunction: Function, oListener: any): this;
        ...
        */
        public getHeaderType(): ThingViewerHeaderType;
        ...
        */
         ...
         * Additionally, it unregisters them from the hosting UIArea.
        */
        public removeAllFacetContent(): any[];
        ...
        */
         ...
         * Default value is `Standard`.
        */
        public setHeaderType(sHeaderType: ThingViewerHeaderType): this;
