    ...
    */
    export default class Exact extends Control {
        ...
        */
         ...
         * Event which is fired when an attribute is selected or unselected.
        */
        attachRefineSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The query string which was entered in the search field */
            query: string, /* * The attribute which was selected or unselected recently */
            changedAttribute: ExactAttribute, /* * Array of all selected ExcatAttribute. */
            allSelectedAttributes: any,
        ...
        */
        attachSearch<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The query string which was entered in the search field. */
            query: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
