declare module 'sap/ui/ux3/Notifier' {
    ...
    */
    export default class Notifier extends Element {
        ...
        */
        attachMessageSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The message that was selected */
