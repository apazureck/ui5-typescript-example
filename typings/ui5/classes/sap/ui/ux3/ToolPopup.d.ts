declare module 'sap/ui/ux3/ToolPopup' {
    ...
    */
    export default class ToolPopup extends Control {
        ...
        */
         ...
         * Event is fired when the popup closes because the user pressed Escape or the ToolPopup Button in the Shell. This is called before the closing animation.
        */
        attachClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired whenever the user clicks the Enter or the Enter key inside the pop up
        */
        attachEnter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The onsapenter event, received by the pop up */
            originalEvent: any, /* * The control that was focused when the user pressed the Enter key (may be null) */
            originalSrcControl: Control,
        ...
        */
         ...
         * Event is fired when one of the icon properties is modified (Note: The icon is not rendered by the ToolPopup). To be used by other controls which want to update the icon in their UI.
        */
        attachIconChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is fired when the popup opens
        */
        attachOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * Event is being fired after the ToolPopup has been opened.
        */
        attachOpened<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        protected fireEnter(mParameters?: { originalEvent?: any, originalSrcControl?: Control, }): this;
