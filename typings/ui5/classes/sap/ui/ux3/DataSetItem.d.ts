declare module 'sap/ui/ux3/DataSetItem' {
    ...
    */
    export default class DataSetItem extends Element {
        ...
        */
         ...
         * Event Fired when Datset item is selected.
        */
        attachSelected<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the selected Datset item */
            itemId: string,
