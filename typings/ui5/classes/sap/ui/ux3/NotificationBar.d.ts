declare module 'sap/ui/ux3/NotificationBar' {
    ...
    export interface INotificationBarSettings extends IControlSettings {
        visibleStatus?: NotificationBarStatus;
    ...
    */
    export default class NotificationBar extends Control {
        ...
        */
         ...
         * Event is fired when the bar wants to be displayed depending on given flag. This allows the application to decide what to do.
        */
        attachDisplay<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Indicates if the bar wants to be shown or hidden */
            show: boolean,
        ...
        */
        attachResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The corresponding status to which the bar was resized. The corresponding heights can be taken for the bar's CSS file. */
