declare module 'sap/ui/table/Table' {
    ...
    import { Toolbar } from "sap/ui/core/library";
    ...
    */
    export default class Table extends Control {
        ...
        */
        attachBusyStateChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachCellClick<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The control of the cell. */
        ...
        */
        attachCellContextmenu<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The control of the cell. */
            cellControl: Control, /* * DOM reference of the clicked cell. Can be used to position the context menu. */
            cellDomRef: any, /* * Row index of the selected cell. */
            rowIndex: number, /* * Column index of the selected cell. This is the index of visible columns and might differ from the index maintained in the column aggregation. */
            columnIndex: number, /* * Column ID of the selected cell. */
        ...
        */
        attachColumnFreeze<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * reference to the column to freeze */
            column: Column,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * fired when a table column is moved.
        */
        attachColumnMove<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * moved column. */
            column: Column, /* * new position of the column. */
            newPos: number,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * fired when a table column is resized.
        */
        attachColumnResize<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * resized column. */
            column: Column, /* * new width of the table column as CSS Size definition. */
            width: sap.ui.core.CSSSize,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachColumnSelect<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * reference to the selected column */
            column: Column,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachColumnVisibility<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * affected column. */
        ...
        */
        attachCustomFilter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * fired when the table is filtered.
        */
        attachFilter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * filtered column. */
            column: Column, /* * filter value. */
            value: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * This event gets fired when the first visible row is changed. It should only be used by composite controls. The event even is fired when setFirstVisibleRow is called programmatically.
        */
        attachFirstVisibleRowChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, void>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * fired when the table is grouped (experimental!).
        */
        attachGroup<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * grouped column. */
            column: Column,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * fired when the row selection of the table has been changed (the event parameters can be used to determine selection changes - to find out the selected rows you should better use the table selection API)
        */
        attachRowSelectionChange<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * row index which has been clicked so that the selection has been changed (either selected or deselected) */
            rowIndex: number, /* * binding context of the row which has been clicked so that selection has been changed */
            rowContext: any, /* * array of row indices which selection has been changed (either selected or deselected) */
            rowIndices: any[], /* * indicator if "select all" function is used to select rows */
            selectAll: boolean, /* * indicates that the event was fired due to an explicit user interaction like clicking the row header or using the keyboard (SPACE or ENTER) to select a row or a range of rows. */
        ...
        */
        attachSort<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * sorted column. */
        ...
        */
        protected fireCellClick(mParameters?: { cellControl?: Control, cellDomRef?: any, rowIndex?: number, columnIndex?: number, columnId?: string, rowBindingContext?: Context, }): boolean;
         ...
         * Listeners may prevent the default action of this event by using the `preventDefault`-method on the event object.
        */
        protected fireCellContextmenu(mParameters?: { cellControl?: Control, cellDomRef?: any, rowIndex?: number, columnIndex?: number, columnId?: string, rowBindingContext?: Context, }): boolean;
        ...
        */
        public setToolbar(oToolbar: Toolbar): this;
