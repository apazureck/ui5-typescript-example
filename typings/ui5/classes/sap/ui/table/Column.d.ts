    ...
    */
    export default class Column extends Element {
        ...
        */
         ...
         * Fires before the column menu is opened.
        */
        attachColumnMenuOpen<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Refence to the selected <code>menu</code> instance to be opened. */
            menu: Menu,
        ...
        */
        public getHAlign(): HorizontalAlign;
        ...
        */
         ...
         * Default value is `Begin`.
        */
        public setHAlign(sHAlign: HorizontalAlign): this;
