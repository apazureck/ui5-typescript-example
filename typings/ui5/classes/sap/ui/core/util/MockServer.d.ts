declare module 'sap/ui/core/util/MockServer' {
    ...
    */
    export default class MockServer extends ManagedObject {
        ...
        */
        public constructor(sId?: string, mSettings?: IMockServerSettings, oScope?: any);
        ...
        */
        public attachAfter(event: string, fnCallback: Function, sEntitySet: string): any;

        /**
            * Attaches an event handler to be called before the built-in request processing of the mock server
        */
        public attachBefore(event: string, fnCallback: Function, sEntitySet: string): any;
        ...
        */
        public detachAfter(event: string, fnCallback: Function, sEntitySet: string): any;

        /**
            * Removes a previously attached event handler
        */
        public detachBefore(event: string, fnCallback: Function, sEntitySet: string): any;
        ...
        */
        public setRequests(requests: any[]): any;
