declare module 'sap/ui/core/EventBus' {
    ...
    */
    export default class EventBus extends Object {
        ...
        */
        public subscribe(sEventId: string, fnFunction: Function, oListener?: any): this;

        /**
            * Attaches an event handler to the event with the given identifier on the given event channel.
        */
        public subscribe(sChannelId: string, sEventId: string, fnFunction: Function, oListener?: any): this;
        ...
        */
        public subscribeOnce(sEventId: string, fnFunction: Function, oListener?: any): this;
         ...
         * When the event occurs, the handler function is called and the handler registration is automatically removed afterwards.
        */
        public subscribeOnce(sChannelId: string, sEventId: string, fnFunction: Function, oListener?: any): this;
        ...
        */
        public unsubscribe(sEventId: string, fnFunction: Function, oListener?: any): this;
         ...
         * The passed parameters must match those used for registration with {@link #subscribe } beforehand!
        */
        public unsubscribe(sChannelId: string, sEventId: string, fnFunction: Function, oListener?: any): this;
