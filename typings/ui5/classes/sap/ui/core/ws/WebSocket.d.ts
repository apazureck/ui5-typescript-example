    ...
    export default class WebSocket extends EventProvider {
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the 'close' event of this `sap.ui.core.ws.WebSocket`.<br>
        */
        attachClose<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Close code provided by the server. */
            code: string, /* * Reason from server for closing the connection. */
            reason: string, /* * Indicates whether the connection was cleanly closed or not. */
            wasClean: string,
        ...
        */
        ...
        /**
            * Attach event-handler `fnFunction` to the 'message' event of this `sap.ui.core.ws.WebSocket`.<br>
        */
        attachMessage<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Received data from the server. */
            data: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
