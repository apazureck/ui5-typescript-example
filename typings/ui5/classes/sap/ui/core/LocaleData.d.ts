declare module 'sap/ui/core/LocaleData' {
    ...
    */
    export default class LocaleData extends Object {
        ...
        */
        public getCombinedDateTimePattern(sDateStyle: string, sTimeStyle: string, sCalendarType?: CalendarType): string;
        ...
        */
        public getCombinedIntervalPattern(sPattern: string, sCalendarType?: CalendarType): string;
        ...
        */
        public getCustomDateTimePattern(sSkeleton: string, sCalendarType?: CalendarType): string;
         ...
         * See http://unicode.org/reports/tr35/tr35-dates.html#availableFormats_appendItems
        */
        public getCustomIntervalPattern(sSkeleton: string, vGreatestDiff: any | string, sCalendarType?: CalendarType): string | any[];

        /**
            * Get date pattern in format "short", "medium", "long" or "full".
        */
        public getDatePattern(sStyle: string, sCalendarType?: CalendarType): string;

        /**
            * Get datetime pattern in style "short", "medium", "long" or "full".
        */
        public getDateTimePattern(sStyle: string, sCalendarType?: CalendarType): string;

        /**
            * Get day periods in width "narrow", "abbreviated" or "wide".
        */
        public getDayPeriods(sWidth: string, sCalendarType?: CalendarType): any[];

        /**
            * Get standalone day periods in width "narrow", "abbreviated" or "wide".
        */
        public getDayPeriodsStandAlone(sWidth: string, sCalendarType?: CalendarType): any[];

        /**
            * Get day names in width "narrow", "abbreviated" or "wide".
        */
        public getDays(sWidth: string, sCalendarType?: CalendarType): any[];

        /**
            * Get stand alone day names in width "narrow", "abbreviated" or "wide".
        */
        public getDaysStandAlone(sWidth: string, sCalendarType?: CalendarType): any[];
        ...
        */
        public getEraDates(sCalendarType?: CalendarType): any[];

        /**
            * Returns array of eras.
        */
        public getEras(sWidth: string, sCalendarType?: CalendarType): any[];
        ...
        */
        public getIntervalPattern(sId: string, sCalendarType?: CalendarType): string;
        ...
        */
        public getMonths(sWidth: string, sCalendarType?: CalendarType): any[];

        /**
            * Get stand alone month names in width "narrow", "abbreviated" or "wide".
        */
        public getMonthsStandAlone(sWidth: string, sCalendarType?: CalendarType): any[];
        ...
        */
        public getPreferredCalendarType(): CalendarType;
        ...
        */
        public getQuarters(sWidth: string, sCalendarType?: CalendarType): any[];

        /**
            * Get stand alone quarter names in width "narrow", "abbreviated" or "wide".
        */
        public getQuartersStandAlone(sWidth: string, sCalendarType?: CalendarType): any[];
        ...
        */
         ...
         * }`
        */
        public getRelativePatterns(aScales: any[], sStyle?: string): any[];
        ...
        */
        public getTimePattern(sStyle: string, sCalendarType?: CalendarType): string;
