    ...
    export default class ScrollBar extends Control {
        ...
        */
        attachScroll<Tcontext>(fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Actions are: Click on track, button, drag of thumb, or mouse wheel click. */
            action: ScrollBarAction, /* * Direction of scrolling: back (up) or forward (down). */
         ...
         * Scroll event.
        */
        attachScroll<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Actions are: Click on track, button, drag of thumb, or mouse wheel click. */
            action: ScrollBarAction, /* * Direction of scrolling: back (up) or forward (down). */
            forward: boolean, /* * Current Scroll position either in pixels or in steps. */
            newScrollPos: number, /* * Old Scroll position - can be in pixels or in steps. */
            oldScrollPos: number,
        ...
        */
        protected fireScroll(mParameters?: { action?: ScrollBarAction, forward?: boolean, newScrollPos?: number, oldScrollPos?: number, }): this;
