    ...
    */
    export default class HTML extends Control {
        ...
        */
         ...
         * When the control doesn't have string content and no preserved DOM existed for this control, then this event will fire, but there won't be a DOM node for this control.
        */
        attachAfterRendering<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Whether the current DOM of the control has been preserved (true) or not (e.g. rendered from content property or it is an empty HTML control). */
            isPreservedDOM: boolean,
