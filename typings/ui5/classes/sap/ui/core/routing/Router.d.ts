declare module 'sap/ui/core/routing/Router' {
    ...
    export default class Router extends EventProvider {
        ...
        */
        public addRoute(oConfig: any, oParent: Route): any;
        ...
        */
         ...
         * 
        */
        attachBeforeRouteMatched<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The name of the route */
            name: string, /* * A key-value pair object which contains the arguments defined in the route resolved with the corresponding information from the current URL hash */
            arguments: any, /* * The configuration object of the route */
            config: any, /* * The nested route instance of this route. The event is fired on this route because the pattern in the nested route is matched with the current URL hash. This parameter can be used to decide whether the current route is matched because of its nested child route. For more information about nested child route please refer to the documentation of oConfig.parent in {@link sap.ui.core.routing.Route#constructor} */
            nestedRoute?: Route,
        ...
        */
         ...
         * 
        */
        attachBypassed<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * the current URL hash which did not match any route */
            hash: string,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * 
        */
        attachRouteMatched<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The name of the route */
            name: string, /* * A key-value pair object which contains the arguments defined in the route resolved with the corresponding information from the current URL hash */
            arguments: any, /* * The configuration object of the route */
            config: any, /* * The nested route instance of this route. The event is fired on this route because the pattern in the nested route is matched with the current URL hash. This parameter can be used to decide whether the current route is matched because of its nested child route. For more information about nested child route please refer to the documentation of oConfig.parent in {@link sap.ui.core.routing.Route#constructor} */
            nestedRoute?: Route,
         ...
         * 
        */
        attachRoutePatternMatched<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The name of the route */
            name: string, /* * A key-value pair object which contains the arguments defined in the route resolved with the corresponding information from the current URL hash */
            arguments: any, /* * The configuration object of the route */
            config: any,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
         ...
         * 
        */
        attachTitleChanged<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The current displayed title */
            title: string, /* * An array which contains the history of previous titles */
            history: any[],
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
         ...
         * 
        */
        public attachViewCreated(oData: any, fnFunction: Function, oListener?: any): this;

        /**
            * Attach event-handler `fnFunction` to the 'viewCreated' event of this `sap.ui.core.routing.Router`.
         * 
        */
        public attachViewCreated(fnFunction: Function, oListener?: any): this;
        ...
        */
        public detachBeforeRouteMatched(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachBypassed(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachRouteMatched(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachRoutePatternMatched(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachTitleChanged(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachViewCreated(fnFunction: Function, oListener: any): this;
        ...
        */
         ...
         * 
        */
        protected fireRoutePatternMatched(mArguments?: any): this;

        /**
            * Fire event viewCreated to attached listeners.
        */
        protected fireViewCreated(mArguments?: any): this;
        ...
        */
        public navTo(sName: string, oParameters?: any, bReplace?: boolean): this;
