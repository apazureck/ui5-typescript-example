declare module 'sap/ui/core/routing/Route' {
    ...
    export default class Route extends EventProvider {
        ...
        */
        public constructor(The: Router, oConfig: { name: string, pattern?: string, greedy?: boolean, parent?: string, target?: string | any[], view?: string, viewType?: string, viewPath?: string, targetParent?: string, targetControl?: string, targetAggregation?: string, clearTarget?: boolean, subroutes?: any, }, oParent?: Route);
        ...
        */
         ...
         * 
        */
        attachBeforeMatched<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The name of the route */
            name: string, /* * A key-value pair object which contains the arguments defined in the route resolved with the corresponding information from the current URL hash */
            arguments: any, /* * The configuration object of the route */
            config: any, /* * The nested route instance of this route. The event is fired on this route because the pattern in the nested route is matched with the current URL hash. This parameter can be used to decide whether the current route is matched because of its nested child route. For more information about nested child route please refer to the documentation of oConfig.parent in {@link sap.ui.core.routing.Route#constructor} */
            nestedRoute?: Route,
        ...
        */
         ...
         * 
        */
        attachMatched<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The name of the route */
            name: string, /* * A key-value pair object which contains the arguments defined in the route resolved with the corresponding information from the current URL hash */
            arguments: any, /* * The configuration object of the route */
            config: any, /* * The nested route instance of this route. The event is fired on this route because the pattern in the nested route is matched with the current URL hash. This parameter can be used to decide whether the current route is matched because of its nested child route. For more information about nested child route please refer to the documentation of oConfig.parent in {@link sap.ui.core.routing.Route#constructor} */
            nestedRoute?: Route,
        ...
        */
         ...
         * 
        */
        attachPatternMatched<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The name of the route */
            name: string, /* * A key-value pair object which contains the arguments defined in the route resolved with the corresponding information from the current URL hash */
            arguments: any, /* * The configuration object of the route */
            config: any,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        public detachBeforeMatched(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachMatched(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones previously used for event registration.
        */
        public detachPatternMatched(fnFunction: Function, oListener: any): this;
        ...
        */
        protected fireBeforeMatched(mArguments?: any): Router;
