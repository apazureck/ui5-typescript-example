declare namespace sap.ui.core {
    ...
    */
    export class Element extends sap.ui.base.ManagedObject {
        ...
        */
        private _attachMediaContainerWidthChange(fnFunction: Function, oListener: any, sName: string): any;

        /**
            * Removes a previously attached event handler from the change events of the screen width/closest media container width.
        */
        private _detachMediaContainerWidthChange(fnFunction: Function, oListener: any, sName: string): any;
        ...
        */
        public findElements(bRecursive: boolean): any[];
        ...
        */
        public removeAllCustomData(): any[];
