declare module 'sap/ui/core/dnd/DragDropInfo' {
    ...
    import * as DragSession from "sap/ui/core/dnd/DragAndDrop";
    type DragSession = any;
    ...
    export interface IDragDropInfoSettings extends IDragDropBaseSettings {
        ...
        dropEffect?: dnd.DropEffect;
        dropPosition?: dnd.DropPosition;
        dropLayout?: dnd.DropLayout;
    }

    /**
    
    */
    export default class DragDropInfo extends DragDropBase {
        ...
        */
        attachDragEnter<Tcontext>(fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The target element on which the dragged element will be dropped */
            ...
            dragSession: DragSession, /* * The underlying browser event */
            browserEvent: any,
         ...
         * This event is fired when a dragged element enters a drop target.
        */
        attachDragEnter<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The target element on which the dragged element will be dropped */
            target: Element, /* * The UI5 <code>dragSession</code> object that exists only during drag and drop */
            dragSession: DragSession, /* * The underlying browser event */
            browserEvent: any,
        ...
        */
        attachDragStart<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The target element that will be dragged */
            target: Element, /* * The UI5 <code>dragSession</code> object that exists only during drag and drop */
            dragSession: DragSession, /* * The underlying browser event */
            browserEvent: any,
        }>, oCustomData?: TcustomData) => void, oListener?: Tcontext): this;
        ...
        */
        attachDrop<TcustomData, Tcontext>(oData: any, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * The UI5 <code>dragSession</code> object that exists only during drag and drop */
            dragSession: DragSession, /* * The element being dragged */
        ...
        */
        public detachDragEnter(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachDragStart(fnFunction: Function, oListener: any): this;
         ...
         * The passed function and listener object must match the ones used for event registration.
        */
        public detachDrop(fnFunction: Function, oListener: any): this;
        ...
        */
        public getDropEffect(): dnd.DropEffect;
        ...
        */
        public getDropLayout(): dnd.DropLayout;
         ...
         * Default value is `On`.
        */
        public getDropPosition(): dnd.DropPosition;
        ...
        */
         ...
         * Default value is `Move`.
        */
        public setDropEffect(sDropEffect: dnd.DropEffect): this;
         ...
         * Default value is `Vertical`.
        */
        public setDropLayout(sDropLayout: dnd.DropLayout): this;
         ...
         * Default value is `On`.
        */
        public setDropPosition(sDropPosition: dnd.DropPosition): this;
